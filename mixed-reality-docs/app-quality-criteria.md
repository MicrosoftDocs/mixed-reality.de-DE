...
### <a name="how-to-measure"></a><span data-ttu-id="b38f0-130">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-130">How to measure</span></span>
...
#### <a name="tools-and-tutorials"></a><span data-ttu-id="b38f0-145">Tools und tutorials</span><span class="sxs-lookup"><span data-stu-id="b38f0-145">Tools and tutorials</span></span>
...
<table>
    ...
    <tr>
     ...
     <tr>
        <td><span data-ttu-id="b38f0-160">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-160">✔️</span></span></td>
...
### <a name="resources"></a><span data-ttu-id="b38f0-181">Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b38f0-181">Resources</span></span>
...
### <a name="device-impact"></a><span data-ttu-id="b38f0-195">Auswirkungen des Geräts</span><span class="sxs-lookup"><span data-stu-id="b38f0-195">Device impact</span></span>
...
### <a name="recommendations"></a><span data-ttu-id="b38f0-212">Empfehlungen</span><span class="sxs-lookup"><span data-stu-id="b38f0-212">Recommendations</span></span>
...
* [<span data-ttu-id="b38f0-227">MR räumlich 230: Räumliche Abbildung</span><span class="sxs-lookup"><span data-stu-id="b38f0-227">MR Spatial 230: Spatial mapping</span></span>](holograms-230.md)
...
### <a name="recommendations"></a><span data-ttu-id="b38f0-258">Empfehlungen</span><span class="sxs-lookup"><span data-stu-id="b38f0-258">Recommendations</span></span>
...
### <a name="how-to-measure"></a><span data-ttu-id="b38f0-308">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-308">How to measure</span></span>
...
#### <a name="tools-and-tutorials"></a><span data-ttu-id="b38f0-325">Tools und tutorials</span><span class="sxs-lookup"><span data-stu-id="b38f0-325">Tools and tutorials</span></span>
...
### <a name="quality-criteria"></a><span data-ttu-id="b38f0-337">Qualitätskriterien</span><span class="sxs-lookup"><span data-stu-id="b38f0-337">Quality criteria</span></span>
...
### <a name="resources"></a><span data-ttu-id="b38f0-358">Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b38f0-358">Resources</span></span>
...
### <a name="how-to-measure"></a><span data-ttu-id="b38f0-384">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-384">How to measure</span></span>
...
#### <a name="tools-and-tutorials"></a><span data-ttu-id="b38f0-401">Tools und tutorials</span><span class="sxs-lookup"><span data-stu-id="b38f0-401">Tools and tutorials</span></span>
...
### <a name="quality-criteria"></a><span data-ttu-id="b38f0-412">Qualitätskriterien</span><span class="sxs-lookup"><span data-stu-id="b38f0-412">Quality criteria</span></span>
...
* [<span data-ttu-id="b38f0-437">Instinktive Interaktionen</span><span class="sxs-lookup"><span data-stu-id="b38f0-437">Instinctual interactions</span></span>](interaction-fundamentals.md)
...
* [<span data-ttu-id="b38f0-462">MR-Eingabe 212: Sprache</span><span class="sxs-lookup"><span data-stu-id="b38f0-462">MR Input 212: Voice</span></span>](holograms-212.md)
...
<span data-ttu-id="b38f0-464">Eine Schaltfläche war lange Zeit eine Metapher, die zum Auslösen eines Ereignisses in der Welt für 2D abstrakt.</span><span class="sxs-lookup"><span data-stu-id="b38f0-464">A button has long been a metaphor used for triggering an event in the 2D abstract world.</span></span> <span data-ttu-id="b38f0-465">In der dreidimensionalen mixed Reality-Welt müssen wir auf dieser Welt mehr Abstraktionsebenen beschränkt werden.</span><span class="sxs-lookup"><span data-stu-id="b38f0-465">In the three-dimensional mixed reality world, we don’t have to be confined to this world of abstraction anymore.</span></span> <span data-ttu-id="b38f0-466">Alles kann ein es Objekt sein, die ein Ereignis auslöst.</span><span class="sxs-lookup"><span data-stu-id="b38f0-466">Anything can be an Interactable object that triggers an event.</span></span> <span data-ttu-id="b38f0-467">Ein Objekt es kann als etwas von einer Tasse Kaffee für die Tabelle, eine Gleitkommazahl in der Luft Sprechblase dargestellt werden.</span><span class="sxs-lookup"><span data-stu-id="b38f0-467">An interactable object can be represented as anything from a coffee cup on the table to a balloon floating in the air.</span></span> <span data-ttu-id="b38f0-468">Unabhängig von der Art sollte es Objekte vom Benutzer über SEH- und Hinweise klar erkennbar sein.</span><span class="sxs-lookup"><span data-stu-id="b38f0-468">Regardless of the form, interactable objects should be clearly recognizable by the user through visual and audio cues.</span></span>

### <a name="device-impact"></a><span data-ttu-id="b38f0-469">Auswirkungen des Geräts</span><span class="sxs-lookup"><span data-stu-id="b38f0-469">Device impact</span></span>
...
<table>
    ...
    <tr>
        <td><span data-ttu-id="b38f0-470"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-470"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span></span></td>
        <td><span data-ttu-id="b38f0-471"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-471"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span></span></td>
        <td></td>
    </tr>
     <tr>
        <td><span data-ttu-id="b38f0-472">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-472">✔️</span></span></td>
        <td><span data-ttu-id="b38f0-473">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-473">✔️</span></span></td>
        <td></td>
    </tr>
</table>

### <a name="quality-criteria"></a><span data-ttu-id="b38f0-474">Qualitätskriterien</span><span class="sxs-lookup"><span data-stu-id="b38f0-474">Quality criteria</span></span>

|  <span data-ttu-id="b38f0-475">Am besten</span><span class="sxs-lookup"><span data-stu-id="b38f0-475">Best</span></span>  |  <span data-ttu-id="b38f0-476">Erfüllt</span><span class="sxs-lookup"><span data-stu-id="b38f0-476">Meets</span></span> |  <span data-ttu-id="b38f0-477">Fehler</span><span class="sxs-lookup"><span data-stu-id="b38f0-477">Fail</span></span> |
--- | --- | ---
|  <span data-ttu-id="b38f0-478">Unabhängig von der Form, es Objekte sind über SEH- und Hinweise erkennbaren über drei Zustände: im Leerlauf, Ziel und ausgewählt.</span><span class="sxs-lookup"><span data-stu-id="b38f0-478">Regardless of form, interactable objects are recognizable through visual and audio cues across three states: idle, targeted, and selected.</span></span> <span data-ttu-id="b38f0-479">"Es noch einmal finden Sie unter" ist klarer und konsistent über die Umgebung verwendet.</span><span class="sxs-lookup"><span data-stu-id="b38f0-479">"See it, say it" is clear and consistently used throughout the experience.</span></span> <span data-ttu-id="b38f0-480">Objekte werden skaliert und verteilt, um für fehlerfrei zu ermöglichen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-480">Objects are scaled and distributed to allow for error free targeting.</span></span> | <span data-ttu-id="b38f0-481">Benutzer können erkennen Objekt als es durch Audio- oder visuelle Feedback, und als Ziel und aktivieren Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="b38f0-481">User can recognize object as interactable through audio or visual feedback, and can target and activate the object.</span></span> | <span data-ttu-id="b38f0-482">Wenn kein visual oder audio-Hinweise, kann Benutzer ein Objekt es nicht erkennen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-482">Given no visual or audio cues, user cannot recognize an interactable object.</span></span> <span data-ttu-id="b38f0-483">Interaktionen sind Fehler aufgrund von Objekt skalieren oder den Abstand zwischen den Objekten entstehen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-483">Interactions are error prone due to object scale or distance between objects.</span></span> | 

### <a name="how-to-measure"></a><span data-ttu-id="b38f0-484">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-484">How to measure</span></span>

* <span data-ttu-id="b38f0-485">Es stehen nebenbei gesagt, immer "es"; bestimmte Schaltflächen, Menüs und app-Inhalte, einschließlich.</span><span class="sxs-lookup"><span data-stu-id="b38f0-485">Interactable objects are recognizable as 'interactable'; including buttons, menus, and app specific content.</span></span> <span data-ttu-id="b38f0-486">Als Faustregel dürfte eine Orientierungshilfe SEH- und wenn es Objekte.</span><span class="sxs-lookup"><span data-stu-id="b38f0-486">As a rule of thumb there should be a visual and audio cue when targeting interactable objects.</span></span>

### <a name="recommendations"></a><span data-ttu-id="b38f0-487">Empfehlungen</span><span class="sxs-lookup"><span data-stu-id="b38f0-487">Recommendations</span></span>

* <span data-ttu-id="b38f0-488">Verwenden Sie SEH- und Feedback für Interaktionen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-488">Use visual and audio feedback for interactions.</span></span>
* <span data-ttu-id="b38f0-489">Visuelles Feedback sollte unterschieden werden, für jede Zustand (im Leerlauf, gezielte, ausgewählte)</span><span class="sxs-lookup"><span data-stu-id="b38f0-489">Visual feedback should be differentiated for each input state (idle, targeted, selected)</span></span>
* <span data-ttu-id="b38f0-490">Es Objekte skaliert, und für die Zielgruppenadressierung fehlerfrei platziert.</span><span class="sxs-lookup"><span data-stu-id="b38f0-490">Interactable objects should be scaled and placed for error free targeting.</span></span>
* <span data-ttu-id="b38f0-491">Gruppierte es Objekte (z. B. eine Menüleiste oder Liste) sollte die richtigen Abstand für die Zielplattform verfügen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-491">Grouped interactable objects (such as a menu bar or list) should have proper spacing for targeting.</span></span>
* <span data-ttu-id="b38f0-492">Schaltflächen und Menüs, die Stimme-Befehl unterstützen sollten die Beschriftungen bereitstellen, für das Befehl-Schlüsselwort ("angezeigt, das so sagen")</span><span class="sxs-lookup"><span data-stu-id="b38f0-492">Buttons and menus that support voice command should provide text labels for the command keyword ("See it, say it")</span></span>

### <a name="resources"></a><span data-ttu-id="b38f0-493">Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b38f0-493">Resources</span></span>

#### <a name="documentation"></a><span data-ttu-id="b38f0-494">Dokumentation</span><span class="sxs-lookup"><span data-stu-id="b38f0-494">Documentation</span></span>

* [<span data-ttu-id="b38f0-495">Interaktionsfähiges Objekt</span><span class="sxs-lookup"><span data-stu-id="b38f0-495">Interactable object</span></span>](interactable-object.md)
* [<span data-ttu-id="b38f0-496">Text in Unity</span><span class="sxs-lookup"><span data-stu-id="b38f0-496">Text in Unity</span></span>](text-in-unity.md)
* [<span data-ttu-id="b38f0-497">App-Leiste und Begrenzungsrahmen</span><span class="sxs-lookup"><span data-stu-id="b38f0-497">App bar and bounding box</span></span>](app-bar-and-bounding-box.md)
* [<span data-ttu-id="b38f0-498">Sprachbefehle</span><span class="sxs-lookup"><span data-stu-id="b38f0-498">Voice commanding</span></span>](voice-design.md)

#### <a name="tools-and-tutorials"></a><span data-ttu-id="b38f0-499">Tools und tutorials</span><span class="sxs-lookup"><span data-stu-id="b38f0-499">Tools and tutorials</span></span>

* [<span data-ttu-id="b38f0-500">Mixed Reality-Toolkit - UX</span><span class="sxs-lookup"><span data-stu-id="b38f0-500">Mixed Reality Toolkit - UX</span></span>](https://github.com/Microsoft/MixedRealityToolkit-Unity/tree/htk_release/Assets/HoloToolkit-Examples/UX)

## <a name="room-scanning"></a><span data-ttu-id="b38f0-501">Raum Scannen</span><span class="sxs-lookup"><span data-stu-id="b38f0-501">Room scanning</span></span>

<span data-ttu-id="b38f0-502">Apps, die räumliche Zuordnungsdaten erfordern basieren auf dem Gerät, um diese Daten im Laufe der Zeit automatisch zu erfassen und untersucht alle Sitzungen als Benutzer ihrer Umgebung mit dem Gerät aktiv.</span><span class="sxs-lookup"><span data-stu-id="b38f0-502">Apps that require spatial mapping data rely on the device to automatically collect this data over time and across sessions as the user explores their environment with the device active.</span></span> <span data-ttu-id="b38f0-503">Der Vollständigkeit und die Qualität der Daten hängt von einer Reihe von Faktoren wie der Menge der, die der Benutzer ausgeführt hat, wie viel Zeit verstrichen ist, da die Auswertung und gibt an, ob die Objekte, z. B. Möbel und Türen verschoben haben, da das Gerät über den Bereich überprüft.</span><span class="sxs-lookup"><span data-stu-id="b38f0-503">The completeness and quality of this data depends on a number of factors including the amount of exploration the user has done, how much time has passed since the exploration and whether objects such as furniture and doors have moved since the device scanned the area.</span></span> <span data-ttu-id="b38f0-504">Viele apps werden analysiert, die räumliche Zuordnungsdaten zu Beginn der Umgebung zu beurteilen, ob der Benutzer zusätzliche Schritte zur Verbesserung der Vollständigkeit und die Qualität der räumliche Zuordnung ausführen soll.</span><span class="sxs-lookup"><span data-stu-id="b38f0-504">Many apps will analyze the spatial mapping data at the start of the experience to judge whether the user should perform additional steps to improve the completeness and quality of the spatial map.</span></span> <span data-ttu-id="b38f0-505">Wenn der Benutzer erforderlich ist, um die Überprüfung der Umgebung, klar, dass während der Überprüfung Oberfläche Anleitungen bereitgestellt werden sollen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-505">If the user is required to scan the environment, clear guidance should be provided during the scanning experience.</span></span>

### <a name="device-impact"></a><span data-ttu-id="b38f0-506">Auswirkungen des Geräts</span><span class="sxs-lookup"><span data-stu-id="b38f0-506">Device impact</span></span>
...
<table>
    ...
    <tr>
        <td><span data-ttu-id="b38f0-507"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-507"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span></span></td>
        <td><span data-ttu-id="b38f0-508"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-508"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span></span></td>
        <td></td>
    </tr>
     <tr>
        <td><span data-ttu-id="b38f0-509">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-509">✔️</span></span></td>
        <td><span data-ttu-id="b38f0-510">❌</span><span class="sxs-lookup"><span data-stu-id="b38f0-510">❌</span></span></td>
        <td></td>
    </tr>
</table>

### <a name="quality-criteria"></a><span data-ttu-id="b38f0-511">Qualitätskriterien</span><span class="sxs-lookup"><span data-stu-id="b38f0-511">Quality criteria</span></span>

|  <span data-ttu-id="b38f0-512">Am besten</span><span class="sxs-lookup"><span data-stu-id="b38f0-512">Best</span></span>  |  <span data-ttu-id="b38f0-513">Erfüllt</span><span class="sxs-lookup"><span data-stu-id="b38f0-513">Meets</span></span> |  <span data-ttu-id="b38f0-514">Fehler</span><span class="sxs-lookup"><span data-stu-id="b38f0-514">Fail</span></span> |
--- | --- | ---
|  <span data-ttu-id="b38f0-515">Visualisierung der räumlichen Mesh erkennen Sie, dass Benutzer, die Überprüfung ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="b38f0-515">Visualization of the spatial mesh tell users scanning is in progress.</span></span> <span data-ttu-id="b38f0-516">Benutzer werden eindeutig weiß, was zu tun ist und wenn die Überprüfung wird gestartet und angehalten wird.</span><span class="sxs-lookup"><span data-stu-id="b38f0-516">User clearly knows what to do and when the scan starts and stops.</span></span> | <span data-ttu-id="b38f0-517">Visualisierung der räumlichen Mesh angegeben ist, ist aber der Benutzer wissen möglicherweise nicht klar, was zu tun ist und keine Statusinformationen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-517">Visualization of the spatial mesh is provided, but the user may not clearly know what to do and no progress information is provided.</span></span> | <span data-ttu-id="b38f0-518">Keine Visualisierung des Mesh.</span><span class="sxs-lookup"><span data-stu-id="b38f0-518">No visualization of mesh.</span></span> <span data-ttu-id="b38f0-519">Keine Informationen bereitgestellt, um dem Benutzer, wo Sie suchen, oder wenn die Überprüfung startet/beendet wird.</span><span class="sxs-lookup"><span data-stu-id="b38f0-519">No guidance information provided to the user regarding where to look, or when the scan starts/stops.</span></span> |

### <a name="how-to-measure"></a><span data-ttu-id="b38f0-520">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-520">How to measure</span></span>

* <span data-ttu-id="b38f0-521">SEH- und bei der Überprüfung erforderlichen Platz bietet es Anleitungen, der angibt, wo gesucht werden soll, und wann starten und beenden zu scannen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-521">During a required room scan, visual and audio guidance is provided indicating where to look, and when to start and stop scanning.</span></span>

### <a name="recommendations"></a><span data-ttu-id="b38f0-522">Empfehlungen</span><span class="sxs-lookup"><span data-stu-id="b38f0-522">Recommendations</span></span>

* <span data-ttu-id="b38f0-523">Geben Sie an, welcher Anteil der Gesamtgröße des Datenträgers in der Nähe der Benutzer muss in der Umgebung sein.</span><span class="sxs-lookup"><span data-stu-id="b38f0-523">Indicate how much of the total volume in the users vicinity needs to be part of the experience.</span></span>
* <span data-ttu-id="b38f0-524">Wenn die Überprüfung wird gestartet und beendet werden, z. B. eine Statusanzeige zu kommunizieren.</span><span class="sxs-lookup"><span data-stu-id="b38f0-524">Communicate when the scan starts and stops such as a progress indicator.</span></span>
* <span data-ttu-id="b38f0-525">Verwenden Sie eine Visualisierung des Netzes während der Überprüfung.</span><span class="sxs-lookup"><span data-stu-id="b38f0-525">Use a visualization of the mesh during the scan.</span></span>
* <span data-ttu-id="b38f0-526">Geben Sie SEH- und Hinweise, um den Benutzern suchen, und bewegen den Raum empfehlen.</span><span class="sxs-lookup"><span data-stu-id="b38f0-526">Provide visual and audio cues to encourage the user to look and move around the room.</span></span>
* <span data-ttu-id="b38f0-527">Informieren Sie den Benutzer, wohin Sie wechseln, um die Daten zu verbessern.</span><span class="sxs-lookup"><span data-stu-id="b38f0-527">Inform the user where to go to improve the data.</span></span> <span data-ttu-id="b38f0-528">In vielen Fällen ist es möglicherweise am besten, die dem Benutzer mitzuteilen, was sie (z. B. die Obergrenze suchen hinter Möbel ansehen), um die Überprüfung der erforderlichen Qualität zu erhalten.</span><span class="sxs-lookup"><span data-stu-id="b38f0-528">In many cases, it may be best to tell the user what they need to do (e.g. look at the ceiling, look behind furniture), in order to get the necessary scan quality.</span></span>

### <a name="resources"></a><span data-ttu-id="b38f0-529">Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b38f0-529">Resources</span></span>

#### <a name="documentation"></a><span data-ttu-id="b38f0-530">Dokumentation</span><span class="sxs-lookup"><span data-stu-id="b38f0-530">Documentation</span></span>

* [<span data-ttu-id="b38f0-531">Raumabtastvisualisierung</span><span class="sxs-lookup"><span data-stu-id="b38f0-531">Room scan visualization</span></span>](room-scan-visualization.md)
* [<span data-ttu-id="b38f0-532">Fallstudie: Erweitern die räumlichen Funktionen für die Zuordnung von HoloLens</span><span class="sxs-lookup"><span data-stu-id="b38f0-532">Case study: Expanding the spatial mapping capabilities of HoloLens</span></span>](case-study-expanding-the-spatial-mapping-capabilities-of-hololens.md)
* [<span data-ttu-id="b38f0-533">Fallstudie: Räumliche Entwurf für HoloTour</span><span class="sxs-lookup"><span data-stu-id="b38f0-533">Case study: Spatial sound design for HoloTour</span></span>](case-study-spatial-sound-design-for-holotour.md)
* [<span data-ttu-id="b38f0-534">Fallstudie: Erstellen ein Eintauchen in Fragmenten</span><span class="sxs-lookup"><span data-stu-id="b38f0-534">Case study: Creating an immersive experience in Fragments</span></span>](case-study-creating-an-immersive-experience-in-fragments.md)

#### <a name="tools-and-tutorials"></a><span data-ttu-id="b38f0-535">Tools und tutorials</span><span class="sxs-lookup"><span data-stu-id="b38f0-535">Tools and tutorials</span></span>

* [<span data-ttu-id="b38f0-536">Mixed Reality-Toolkit - UX</span><span class="sxs-lookup"><span data-stu-id="b38f0-536">Mixed Reality Toolkit - UX</span></span>](https://github.com/Microsoft/MixedRealityToolkit-Unity/tree/htk_release/Assets/HoloToolkit-Examples/UX)

## <a name="directional-indicators"></a><span data-ttu-id="b38f0-537">Direktionale Indikatoren</span><span class="sxs-lookup"><span data-stu-id="b38f0-537">Directional indicators</span></span>

<span data-ttu-id="b38f0-538">In einer mixed Reality-app Inhalt möglicherweise außerhalb der Sichtfeld oder von realen Objekten okkludiert.</span><span class="sxs-lookup"><span data-stu-id="b38f0-538">In a mixed reality app, content may be outside the field of view or occluded by real-world objects.</span></span> <span data-ttu-id="b38f0-539">Eine wohlgeformte-app wird für den Benutzer nicht sichtbaren Inhalt erleichtern.</span><span class="sxs-lookup"><span data-stu-id="b38f0-539">A well designed app will make it easier for the user to find non-visible content.</span></span> <span data-ttu-id="b38f0-540">Direktionale Indikatoren warnen ein Benutzers auf wichtige Inhalte und bieten eine Anleitung, um den Inhalt relativ zur Position des Benutzers.</span><span class="sxs-lookup"><span data-stu-id="b38f0-540">Directional indicators alert a user to important content and provide guidance to the content relative to the user's position.</span></span> <span data-ttu-id="b38f0-541">Anleitungen, die nicht sichtbaren Inhalt kann es sich um die Form der sound korrekturemitter ab, mithilfe von Richtungspfeilen oder direkte visuelle Hinweise haben.</span><span class="sxs-lookup"><span data-stu-id="b38f0-541">Guidance to non-visible content can take the form of sound emitters, directional arrows, or direct visual cues.</span></span>

### <a name="device-impact"></a><span data-ttu-id="b38f0-542">Auswirkungen des Geräts</span><span class="sxs-lookup"><span data-stu-id="b38f0-542">Device impact</span></span>
...
<table>
    ...
    <tr>
        <td><span data-ttu-id="b38f0-543"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-543"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span></span></td>
        <td><span data-ttu-id="b38f0-544"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-544"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span></span></td>
        <td></td>
    </tr>
     <tr>
        <td><span data-ttu-id="b38f0-545">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-545">✔️</span></span></td>
        <td><span data-ttu-id="b38f0-546">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-546">✔️</span></span></td>
        <td></td>
    </tr>
</table>

### <a name="quality-criteria"></a><span data-ttu-id="b38f0-547">Qualitätskriterien</span><span class="sxs-lookup"><span data-stu-id="b38f0-547">Quality criteria</span></span>

|  <span data-ttu-id="b38f0-548">Am besten</span><span class="sxs-lookup"><span data-stu-id="b38f0-548">Best</span></span>  |  <span data-ttu-id="b38f0-549">Erfüllt</span><span class="sxs-lookup"><span data-stu-id="b38f0-549">Meets</span></span> |  <span data-ttu-id="b38f0-550">Fehler</span><span class="sxs-lookup"><span data-stu-id="b38f0-550">Fail</span></span> |
--- | --- | ---
|  <span data-ttu-id="b38f0-551">SEH- und Hinweise führen den Benutzer direkt zu den relevanten Inhalten außerhalb Blickfeld.</span><span class="sxs-lookup"><span data-stu-id="b38f0-551">Visual and audio cues directly guide the user to relevant content outside the field of view.</span></span> | <span data-ttu-id="b38f0-552">Ein Pfeil, oder einige Indikator, der der Benutzer in die allgemeine Richtung an, der den Inhalt verweist.</span><span class="sxs-lookup"><span data-stu-id="b38f0-552">An arrow or some indicator that points the user in the general direction of the content.</span></span> | <span data-ttu-id="b38f0-553">Relevante Inhalte außerhalb der Sichtfeld, und eine schlechte oder kein Speicherort enthält Anweisungen für den Benutzer.</span><span class="sxs-lookup"><span data-stu-id="b38f0-553">Relevant content is outside of the field of view, and poor or no location guidance is provided to the user.</span></span> | 

### <a name="how-to-measure"></a><span data-ttu-id="b38f0-554">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-554">How to measure</span></span>

* <span data-ttu-id="b38f0-555">Relevante Inhalte außerhalb der Sicht des Benutzers ist visual und/oder Hinweise ermittelt.</span><span class="sxs-lookup"><span data-stu-id="b38f0-555">Relevant content outside of the user field of view is discoverable through visual and/or audio cues.</span></span>

### <a name="recommendations"></a><span data-ttu-id="b38f0-556">Empfehlungen</span><span class="sxs-lookup"><span data-stu-id="b38f0-556">Recommendations</span></span>

* <span data-ttu-id="b38f0-557">Verwenden Sie, wenn außerhalb des Benutzers Sichtfeld relevanten Inhalt ist ein direktionaler Indikatoren und Audiohinweise an den Benutzer auf den Inhalt.</span><span class="sxs-lookup"><span data-stu-id="b38f0-557">When relevant content is outside the user's field of view, use directional indicators and audio cues to guide the user to the content.</span></span> <span data-ttu-id="b38f0-558">In vielen Fällen wird eine direkte visuelle Anleitung über Richtungspfeile bevorzugt.</span><span class="sxs-lookup"><span data-stu-id="b38f0-558">In many cases, a direct visual guide is preferred over directional arrows.</span></span>
* <span data-ttu-id="b38f0-559">Direktionale Indikatoren sollten in den Cursor nicht erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="b38f0-559">Directional indicators should not be built into the cursor.</span></span>

### <a name="resources"></a><span data-ttu-id="b38f0-560">Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b38f0-560">Resources</span></span>

* [<span data-ttu-id="b38f0-561">Holografischer Rahmen</span><span class="sxs-lookup"><span data-stu-id="b38f0-561">Holographic frame</span></span>](holographic-frame.md)

## <a name="data-loading"></a><span data-ttu-id="b38f0-562">Laden von Daten</span><span class="sxs-lookup"><span data-stu-id="b38f0-562">Data loading</span></span>

<span data-ttu-id="b38f0-563">Ein Statussteuerelement gibt dem Benutzer eine Rückmeldung, dass ein Vorgang mit langer Laufzeit ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="b38f0-563">A progress control provides feedback to the user that a long-running operation is underway.</span></span> <span data-ttu-id="b38f0-564">Dies kann bedeuten, dass der Benutzer mit der app interagieren nicht möglich, wenn die Statusanzeige angezeigt wird und auch angeben kann, wie lange die Wartezeit möglicherweise.</span><span class="sxs-lookup"><span data-stu-id="b38f0-564">It can mean that the user cannot interact with the app when the progress indicator is visible and can also indicate how long the wait time might be.</span></span>

### <a name="device-impact"></a><span data-ttu-id="b38f0-565">Auswirkungen des Geräts</span><span class="sxs-lookup"><span data-stu-id="b38f0-565">Device impact</span></span>
...
<table>
    ...
    <tr>
        <td><span data-ttu-id="b38f0-566"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-566"><a href="hololens-hardware-details.md"><strong>HoloLens</strong></a></span></span></td>
        <td><span data-ttu-id="b38f0-567"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span><span class="sxs-lookup"><span data-stu-id="b38f0-567"><a href="immersive-headset-hardware-details.md"><strong>Immersive headsets</strong></a></span></span></td>
        <td></td>
    </tr>
     <tr>
        <td><span data-ttu-id="b38f0-568">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-568">✔️</span></span></td>
        <td><span data-ttu-id="b38f0-569">✔️</span><span class="sxs-lookup"><span data-stu-id="b38f0-569">✔️</span></span></td>
        <td></td>
    </tr>
</table>

### <a name="quality-criteria"></a><span data-ttu-id="b38f0-570">Qualitätskriterien</span><span class="sxs-lookup"><span data-stu-id="b38f0-570">Quality criteria</span></span>

|  <span data-ttu-id="b38f0-571">Am besten</span><span class="sxs-lookup"><span data-stu-id="b38f0-571">Best</span></span>  |  <span data-ttu-id="b38f0-572">Erfüllt</span><span class="sxs-lookup"><span data-stu-id="b38f0-572">Meets</span></span> |  <span data-ttu-id="b38f0-573">Fehler</span><span class="sxs-lookup"><span data-stu-id="b38f0-573">Fail</span></span> |
--- | --- | ---
|  <span data-ttu-id="b38f0-574">Animierte visueller Indikator in Form einer Statusanzeige oder Ring, das Aufzeigen von Fortschritten bei der keine Daten laden oder zu verarbeiten.</span><span class="sxs-lookup"><span data-stu-id="b38f0-574">Animated visual indicator, in the form of a progress bar or ring, showing progress during any data loading or processing.</span></span> <span data-ttu-id="b38f0-575">Der visuelle Indikator enthält Anleitungen, wie lange die Wartezeit werden konnte.</span><span class="sxs-lookup"><span data-stu-id="b38f0-575">The visual indicator provides guidance on how long the wait could be.</span></span> | <span data-ttu-id="b38f0-576">Benutzer wird darüber informiert, dass das Laden von Daten ausgeführt wird, aber es gibt keinen Hinweis dafür, wie lange die Wartezeit sein kann.</span><span class="sxs-lookup"><span data-stu-id="b38f0-576">User is informed that data loading is in progress, but there is no indication of how long the wait could be.</span></span> | <span data-ttu-id="b38f0-577">Kein Laden von Daten oder die Prozess-Indikatoren für die Aufgabe, die länger als 5 Sekunden dauert.</span><span class="sxs-lookup"><span data-stu-id="b38f0-577">No data loading or process indicators for task taking longer than 5 seconds.</span></span> |

### <a name="how-to-measure"></a><span data-ttu-id="b38f0-578">Gewusst wie: messen</span><span class="sxs-lookup"><span data-stu-id="b38f0-578">How to measure</span></span>

* <span data-ttu-id="b38f0-579">Stellen Sie sicher, dass es mehr als 5 Sekunden ist kein leerer Zustand, beim Laden der Daten.</span><span class="sxs-lookup"><span data-stu-id="b38f0-579">During data loading verify there is no blank state for more than 5 seconds.</span></span>

### <a name="recommendations"></a><span data-ttu-id="b38f0-580">Empfehlungen</span><span class="sxs-lookup"><span data-stu-id="b38f0-580">Recommendations</span></span>

* <span data-ttu-id="b38f0-581">Geben Sie eine Data Loading Animator-aufzeigen von Fortschritten in allen Fällen, wenn der Benutzer diese app abgestürzt ist oder die Beantwortung wahrnehmen könnten.</span><span class="sxs-lookup"><span data-stu-id="b38f0-581">Provide a data loading animator showing progress in any situation when the user may perceive this app to have stalled or crashed.</span></span> <span data-ttu-id="b38f0-582">Eine gute Faustregel ist, alle "laden"-Aktivität, die mehr als 5 Sekunden dauern.</span><span class="sxs-lookup"><span data-stu-id="b38f0-582">A reasonable rule of thumb is any 'loading' activity that could take more than 5 seconds.</span></span>

### <a name="resources"></a><span data-ttu-id="b38f0-583">Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b38f0-583">Resources</span></span>

* [<span data-ttu-id="b38f0-584">Anzeigen des Fortschritts</span><span class="sxs-lookup"><span data-stu-id="b38f0-584">Displaying progress</span></span>](progress.md)
