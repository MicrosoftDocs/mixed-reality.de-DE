...
Wenn das **mixedrealitytoolkit** -Objekt im Fenster Hierarchie ausgewählt ist, klicken Sie im Inspektor-Fenster auf die Schaltfläche zum **Kopieren & anpassen** , um das Fenster Klon Profil zu öffnen:
...
Wenn das PressableButtonHoloLens2-Objekt im Fenster Hierarchie ausgewählt ist, wählen Sie im **Inspektor** -Fenster **Hamburger-Menü**die Option **alle Komponenten** reduzieren aus, um eine Übersicht über alle Komponenten dieses Objekts zu erhalten:
...
Ändern Sie für den Ereignis Empfängertyp **interactableonpressreceiver**den **Interaktions Filter** in **Near und Far**:
