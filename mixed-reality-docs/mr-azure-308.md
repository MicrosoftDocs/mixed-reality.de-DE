...
1. <span data-ttu-id="f0c1a-124">Die app von Desktop-PC kann sich der Benutzer zum Verschieben eines Objekts in einem 2D-Bereich (X und Y), mit der Maus.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-124">The Desktop PC app will allow the user to move an object in 2D space (X and Y), using the mouse.</span></span>
...
## <a name="before-you-start"></a><span data-ttu-id="f0c1a-154">Bevor Sie beginnen</span><span class="sxs-lookup"><span data-stu-id="f0c1a-154">Before you start</span></span>
...
4.  <span data-ttu-id="f0c1a-191">Nachdem Sie auf geklickt haben ***erstellen***:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-191">Once you have clicked on ***Create***:</span></span>
    ...
    1.  <span data-ttu-id="f0c1a-192">Fügen Sie dem gewünschten Namen für diese Dienstinstanz.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-192">Insert your desired name for this service instance.</span></span>
...
4.  <span data-ttu-id="f0c1a-268">Ihre Azure-Cloud-Dienste werden angezeigt.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-268">Your Azure cloud services will be shown.</span></span> <span data-ttu-id="f0c1a-269">Suchen **Speicherkonten** , und klicken Sie auf den Pfeil auf der linken Seite, um Ihre Konten zu erweitern.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-269">Find **Storage Accounts** and click the arrow to the left of that to expand your accounts.</span></span>
...
10. <span data-ttu-id="f0c1a-286">Klicken Sie anschließend auf **OK**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-286">Click **OK** when you are finished.</span></span>
...
6.  <span data-ttu-id="f0c1a-317">Nachdem Sie auf geklickt haben **erstellen**, geben Sie Folgendes:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-317">Once you have clicked on **Create**, fill in the following:</span></span>
    ...
    8. <span data-ttu-id="f0c1a-328">Für die **Storage** Abschnitt **müssen Sie den Storage-Dienst, die Sie im vorherigen Schritt erstellt haben, auswählen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-328">For the **Storage** section, **you must select the Storage Service you created in the previous step**.</span></span>
...
17. <span data-ttu-id="f0c1a-359">Fügen Sie den folgenden Code in der Funktions-Editor (ersetzen Sie den Code in der Funktion):</span><span class="sxs-lookup"><span data-stu-id="f0c1a-359">Insert the following code into the function editor (replacing the code in the function):</span></span>
...
24. <span data-ttu-id="f0c1a-376">Klicken Sie auf der nächsten Seite in der oberen rechten Ecke auf **erweiterter Editor** (wie folgt).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-376">On the next page, in the top right corner, click **Advanced editor** (as below).</span></span>
...
28. <span data-ttu-id="f0c1a-385">In der **Standardeditor**, klicken Sie auf **Azure Table Storage (Tabelle)** unter **Eingaben**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-385">Back in the **Standard editor**, click **Azure Table Storage (table)**, under **Inputs**.</span></span> 
...
30. <span data-ttu-id="f0c1a-396">Klicken Sie anschließend **Azure Notification Hub (Benachrichtigung)** – unter **Ausgaben**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-396">Next, click **Azure Notification Hub (notification)** - under **Outputs**.</span></span> <span data-ttu-id="f0c1a-397">Stellen Sie sicher, die folgenden zugeordnet sind **Ihre** Informationen, wie sie verschieden sein können (es gibt ein Bild auf die folgenden Schritte aus):</span><span class="sxs-lookup"><span data-stu-id="f0c1a-397">Ensure the following are matched to **your** information, as they may be different (there is an image below the following steps):</span></span>
    ...
    2.  <span data-ttu-id="f0c1a-399">**Namespaceverbindung für Notification Hubs**: Klicken Sie auf **neue**, die zusammen mit dem Dropdown-Menü angezeigt wird.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-399">**Notification Hubs namespace connection**: click **new**, which appears alongside the dropdown menu.</span></span>
...
<span data-ttu-id="f0c1a-425">Richten Sie ein und Testen Sie Ihrer mixed Reality immersive Kopfhörer.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-425">Set up and test your mixed reality immersive headset.</span></span>
...
5.  <span data-ttu-id="f0c1a-442">In der **Datei** > **Buildeinstellungen**, stellen Sie sicher, dass:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-442">While still in **File** > **Build Settings**, make sure that:</span></span>
    ...
    6.  <span data-ttu-id="f0c1a-449">Hier lohnt sich die Szene speichern und mit dem Build hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-449">While here, it is worth saving the scene, and adding it to the build.</span></span>

        1. <span data-ttu-id="f0c1a-450">Hierzu **öffnen Szenen hinzufügen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-450">Do this by selecting **Add Open Scenes**.</span></span> <span data-ttu-id="f0c1a-451">Ein Speichern Fenster wird angezeigt.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-451">A save window will appear.</span></span>

            ![Hinzufügen von öffnen-Szenen](images/AzureLabs-Lab8-56.png)

        2. <span data-ttu-id="f0c1a-453">Erstellen einen neuen Ordner für, und alle zukünftigen, Szene, klicken Sie dann auf die **neuer Ordner** Schaltfläche zum Erstellen eines neuen Ordners, nennen Sie sie **Szenen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-453">Create a new folder for this, and any future, scene, then select the **New folder** button, to create a new folder, name it **Scenes**.</span></span>

            ![neuen Ordner "Szenen"](images/AzureLabs-Lab8-57.png)

        3. <span data-ttu-id="f0c1a-455">Öffnen Sie den neu erstellten **Szenen** Ordner, und klicken Sie dann in der **Dateiname:** Textfeld **Notification Hub\_Desktop\_Szene**, drücken Sie dann die **Speichern**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-455">Open your newly created **Scenes** folder, and then in the **File name:** text field, type **NH\_Desktop\_Scene**, then press **Save**.</span></span>

            ![neue NH_Desktop_Scene](images/AzureLabs-Lab8-58.png)

    7.  <span data-ttu-id="f0c1a-457">Die Einstellungen im verbleibenden **Buildeinstellungen**, sollte jetzt als Standard bleiben.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-457">The remaining settings, in **Build Settings**, should be left as default for now.</span></span>

6.  <span data-ttu-id="f0c1a-458">Klicken Sie in demselben Fenster auf die **Playereinstellungen** Schaltfläche Dies öffnet den entsprechenden Bereich im Bereich, in dem die **Inspektor** befindet.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-458">In the same window click on the **Player Settings** button, this will open the related panel in the space where the **Inspector** is located.</span></span>

7.  <span data-ttu-id="f0c1a-459">In diesem Bereich sind müssen einige Einstellungen überprüft werden:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-459">In this panel, a few settings need to be verified:</span></span>

    1.  <span data-ttu-id="f0c1a-460">In der **Weitere Einstellungen** Registerkarte:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-460">In the **Other Settings** tab:</span></span>

        1.  <span data-ttu-id="f0c1a-461">**Scripting Runtime Version** muss **experimentell (.NET 4.6 Äquivalent)**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-461">**Scripting Runtime Version** should be **Experimental (.NET 4.6 Equivalent)**</span></span>

        2. <span data-ttu-id="f0c1a-462">**Back-End-Scripting** muss **.NET**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-462">**Scripting Backend** should be **.NET**</span></span>

        3. <span data-ttu-id="f0c1a-463">**API-Kompatibilitätsebene** muss **.NET 4.6**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-463">**API Compatibility Level** should be **.NET 4.6**</span></span>

            ![net-Version 4.6](images/AzureLabs-Lab8-59.png)

    2.  <span data-ttu-id="f0c1a-465">In der **Veröffentlichungseinstellungen** Registerkarte **Funktionen**, überprüfen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-465">Within the **Publishing Settings** tab, under **Capabilities**, check:</span></span>

        - <span data-ttu-id="f0c1a-466">**InternetClient**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-466">**InternetClient**</span></span>

            ![Takt-Internetclient](images/AzureLabs-Lab8-60.png)

8.  <span data-ttu-id="f0c1a-468">Im **Buildeinstellungen** *Unity C\# Projekte* nicht mehr abgeblendet ist, aktivieren Sie das Kontrollkästchen neben dieser.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-468">Back in **Build Settings** *Unity C\# Projects* is no longer greyed out; tick the checkbox next to this.</span></span>

9.  <span data-ttu-id="f0c1a-469">Schließen der **Buildeinstellungen** Fenster.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-469">Close the **Build Settings** window.</span></span>

10. <span data-ttu-id="f0c1a-470">Speichern Sie Ihre Szene und das Projekt **Datei** > **Szene speichern / File** > **Projekt speichern**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-470">Save your Scene and Project **File** > **Save Scene / File** > **Save Project**.</span></span>

    > [!IMPORTANT]
    > <span data-ttu-id="f0c1a-471">Wenn Sie, überspringen möchten die *Unity einrichten* Komponente für dieses Projekt (Desktop-App), weiterhin direkt in Code, und Sie gerne [Herunterladen dieser .unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-Desktop.unitypackage), importieren Sie es in Ihr Projekt als eine [ **Custom Package**](https://docs.unity3d.com/Manual/AssetPackages.html), und klicken Sie dann eine Fortsetzung [Kapitel 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-471">If you wish to skip the *Unity Set up* component for this project (Desktop App), and continue straight into code, feel free to [download this .unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-Desktop.unitypackage), import it into your project as a [**Custom Package**](https://docs.unity3d.com/Manual/AssetPackages.html), and then continue from [Chapter 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span></span>  <span data-ttu-id="f0c1a-472">Sie müssen weiterhin die Skriptkomponenten hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-472">You will still need to add the script components.</span></span>

## <a name="chapter-8---importing-the-dlls-in-unity"></a><span data-ttu-id="f0c1a-473">Kapitel 8 – Importieren von die DLLs in Unity</span><span class="sxs-lookup"><span data-stu-id="f0c1a-473">Chapter 8 - Importing the DLLs in Unity</span></span>

<span data-ttu-id="f0c1a-474">Verwenden Sie Azure Storage für Unity (die wiederum nutzt das .net SDK für Azure).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-474">You will be using Azure Storage for Unity (which itself leverages the .Net SDK for Azure).</span></span> <span data-ttu-id="f0c1a-475">Weitere Informationen führen Sie diesen [Link zu Azure Storage für Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-475">For more information follow this [link about Azure Storage for Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span></span>

<span data-ttu-id="f0c1a-476">Es befindet sich derzeit ein bekanntes Problem in Unity-Plug-Ins neu konfiguriert werden, nach dem Import erfordert.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-476">There is currently a known issue in Unity which requires plugins to be reconfigured after import.</span></span> <span data-ttu-id="f0c1a-477">Diese Schritte (4 bis 7 in diesem Abschnitt) ist nicht mehr erforderlich, nachdem der Fehler behoben wurde.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-477">These steps (4 - 7 in this section) will no longer be required after the bug has been resolved.</span></span>

<span data-ttu-id="f0c1a-478">Um das SDK in Ihr eigenes Projekt zu importieren, stellen Sie sicher, dass Sie heruntergeladen haben, die neueste Version [ **.unitypackage** ](https://aka.ms/azstorage-unitysdk) aus GitHub.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-478">To import the SDK into your own project, make sure you have downloaded the latest [**.unitypackage**](https://aka.ms/azstorage-unitysdk) from GitHub.</span></span> <span data-ttu-id="f0c1a-479">Führen Sie anschließend folgende Schritte aus:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-479">Then, do the following:</span></span>

1.  <span data-ttu-id="f0c1a-480">Hinzufügen der **.unitypackage** in Unity mithilfe der **Assets \> Paket importieren \> Custom Package** Option des Menüs.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-480">Add the **.unitypackage** to Unity by using the **Assets \> Import Package \> Custom Package** menu option.</span></span>

2.  <span data-ttu-id="f0c1a-481">In der **Unity-Paket importieren** Feld angezeigt, alles unter können Sie auswählen \*\* *-Plug-Ins* \> \* Storage \*\*\*.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-481">In the **Import Unity Package** box that pops up, you can select everything under \*\**Plugin* \> \*Storage\*\*\*.</span></span>  <span data-ttu-id="f0c1a-482">Deaktivieren Sie alles andere, da sie für diesen Kurs nicht benötigt wird.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-482">Uncheck everything else, as it is not needed for this course.</span></span>

    ![Paket importieren](images/AzureLabs-Lab8-61.png)

3.  <span data-ttu-id="f0c1a-484">Klicken Sie auf die ***Import*** , um die Elemente zu Ihrem Projekt hinzuzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-484">Click the ***Import*** button to add the items to your project.</span></span>

4.  <span data-ttu-id="f0c1a-485">Wechseln Sie zu der **Storage** Unterordner **-Plug-Ins** im Projekt anzuzeigen, und wählen Sie die folgenden Plug-Ins *nur*:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-485">Go to the **Storage** folder under **Plugins** in the Project view and select the following plugins *only*:</span></span>

    -   <span data-ttu-id="f0c1a-486">Microsoft.Data.Edm</span><span class="sxs-lookup"><span data-stu-id="f0c1a-486">Microsoft.Data.Edm</span></span>
    -   <span data-ttu-id="f0c1a-487">Microsoft.Data.OData</span><span class="sxs-lookup"><span data-stu-id="f0c1a-487">Microsoft.Data.OData</span></span>
    -   <span data-ttu-id="f0c1a-488">Microsoft.WindowsAzure.Storage</span><span class="sxs-lookup"><span data-stu-id="f0c1a-488">Microsoft.WindowsAzure.Storage</span></span>
    -   <span data-ttu-id="f0c1a-489">Newtonsoft.Json</span><span class="sxs-lookup"><span data-stu-id="f0c1a-489">Newtonsoft.Json</span></span>
    -   <span data-ttu-id="f0c1a-490">System.Spatial</span><span class="sxs-lookup"><span data-stu-id="f0c1a-490">System.Spatial</span></span>

![Deaktivieren Sie jede Plattform](images/AzureLabs-Lab8-62.png)

5.  <span data-ttu-id="f0c1a-492">Mit *bestimmte Plug-Ins* ausgewählt, **deaktivieren** **Any Platform** und **deaktivieren** **WSAPlayer** Klicken Sie dann auf **übernehmen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-492">With *these specific plugins* selected, **uncheck** **Any Platform** and **uncheck** **WSAPlayer** then click **Apply**.</span></span>

    ![Anwenden von Plattform-dlls](images/AzureLabs-Lab8-63.png)

    > [!NOTE] 
    > <span data-ttu-id="f0c1a-494">Wir markieren diese bestimmten Plug-Ins, die nur im Unity-Editor verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-494">We are marking these particular plugins to only be used in the Unity Editor.</span></span> <span data-ttu-id="f0c1a-495">Dies ist, da es gibt verschiedene Versionen der gleichen Plug-Ins in das WSA-Ordner, der verwendet wird und nachdem das Projekt aus Unity exportiert werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-495">This is because there are different versions of the same plugins in the WSA folder that will be used after the project is exported from Unity.</span></span>

6.  <span data-ttu-id="f0c1a-496">In der **Storage** -Plug-in-Ordner, wählen Sie nur:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-496">In the **Storage** plugin folder, select only:</span></span>

    -   <span data-ttu-id="f0c1a-497">Microsoft.Data.Services.Client</span><span class="sxs-lookup"><span data-stu-id="f0c1a-497">Microsoft.Data.Services.Client</span></span>

        ![Gruppe nicht für DLL-Dateien verarbeiten](images/AzureLabs-Lab8-64.png)

7.  <span data-ttu-id="f0c1a-499">Überprüfen Sie die **Don't Prozess** Feld **Plattformeinstellungen** , und klicken Sie auf ***übernehmen***.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-499">Check the **Don't Process** box under **Platform Settings** and click ***Apply***.</span></span>

    ![keine Verarbeitung anwenden](images/AzureLabs-Lab8-65.png)

    > [!NOTE] 
    > <span data-ttu-id="f0c1a-501">Wir werden dieses Plug-in "Nicht verarbeiten", markieren, da die Unity-Assembly-Patcher schwierigkeiten beim Verarbeiten dieses Plug-in ist.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-501">We are marking this plugin "Don't process", because the Unity assembly patcher has difficulty processing this plugin.</span></span> <span data-ttu-id="f0c1a-502">Das Plug-in funktioniert weiterhin, auch wenn sie nicht verarbeitet wurde.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-502">The plugin will still work even though it is not processed.</span></span>

## <a name="chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project"></a><span data-ttu-id="f0c1a-503">Kapitel 9 – erstellen Sie die TableToScene-Klasse in der Desktop Unity-Projekt</span><span class="sxs-lookup"><span data-stu-id="f0c1a-503">Chapter 9 - Create the TableToScene class in the Desktop Unity project</span></span>

<span data-ttu-id="f0c1a-504">Nun müssen Sie die Skripts, die den Code zum Ausführen dieser Anwendung zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-504">You now need to create the scripts containing the code to run this application.</span></span>

<span data-ttu-id="f0c1a-505">Ist das erste Skript, das Sie erstellen müssen **TableToScene**, die für verantwortlich ist:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-505">The first script you need to create is **TableToScene**, which is responsible for:</span></span>

-   <span data-ttu-id="f0c1a-506">Lesen von Entitäten innerhalb der Azure-Tabelle.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-506">Reading entities within the Azure Table.</span></span>
-   <span data-ttu-id="f0c1a-507">Die Daten dieser Tabelle, bestimmen, welche Objekte zu erzeugen, und an welcher Position.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-507">Using the Table data, determine which objects to spawn, and in which position.</span></span>

<span data-ttu-id="f0c1a-508">Ist das zweite Skript, das Sie erstellen müssen **CloudScene**, die für verantwortlich ist:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-508">The second script you need to create is **CloudScene**, which is responsible for:</span></span>

-   <span data-ttu-id="f0c1a-509">Registrieren das Ereignis klicken, um dem Benutzer ermöglichen, Objekte in der Szene ziehen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-509">Registering the left-click event, to allow the user to drag objects around the scene.</span></span>
-   <span data-ttu-id="f0c1a-510">Serialisieren von Daten des Objekts, von diese Unity-Szene, und sie an der Azure-Funktions-App senden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-510">Serializing the object data from this Unity scene, and sending it to the Azure Function App.</span></span>

<span data-ttu-id="f0c1a-511">Diese Klasse zu erstellen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-511">To create this class:</span></span>

1.  <span data-ttu-id="f0c1a-512">Mit der rechten Maustaste den **Asset** Ordner befindet sich im Projektfenster **erstellen** > **Ordner**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-512">Right-click in the **Asset** Folder located in the Project Panel, **Create** > **Folder**.</span></span> <span data-ttu-id="f0c1a-513">Nennen Sie den Ordner **Skripts**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-513">Name the folder **Scripts**.</span></span>

    ![Erstellen Sie Ordner "Scripts"](images/AzureLabs-Lab8-66.png)

    ![Erstellen Sie Ordner "Scripts" 2](images/AzureLabs-Lab8-67.png)

2.  <span data-ttu-id="f0c1a-516">Doppelklicken Sie auf den Ordner, der gerade erstellt haben, um ihn zu öffnen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-516">Double click on the folder just created, to open it.</span></span>

3.  <span data-ttu-id="f0c1a-517">Klicken Sie auf auf die **Skripts** Ordner, klicken Sie auf **erstellen**  >   **C# Skript**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-517">Right-click inside the **Scripts** folder, click **Create** > **C# Script**.</span></span> <span data-ttu-id="f0c1a-518">Nennen Sie das Skript **TableToScene**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-518">Name the script **TableToScene**.</span></span>

    <span data-ttu-id="f0c1a-519">![neue c#-Skript](images/AzureLabs-Lab8-68.png)
    ![TableToScene umbenennen](images/AzureLabs-Lab8-69.png)</span><span class="sxs-lookup"><span data-stu-id="f0c1a-519">![new c# script](images/AzureLabs-Lab8-68.png)
![TableToScene rename](images/AzureLabs-Lab8-69.png)</span></span>

4.  <span data-ttu-id="f0c1a-520">Doppelklicken Sie auf das Skript aus, um sie in Visual Studio 2017 öffnen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-520">Double-click on the script to open it in Visual Studio 2017.</span></span>

5.  <span data-ttu-id="f0c1a-521">Fügen Sie die folgenden Namespaces hinzu:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-521">Add the following namespaces:</span></span>
...
6.  <span data-ttu-id="f0c1a-522">Fügen Sie innerhalb der Klasse die folgenden Variablen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-522">Within the class, insert the following variables:</span></span>
    ...
    > [!NOTE] 
    > <span data-ttu-id="f0c1a-523">Ersetzen der **AccountName** Wert durch den Namen Ihres Azure Storage-Dienst und **AccountKey** Wert mit dem Schlüsselwert finden Sie in den Azure Storage-Dienst im Azure-Portal (siehe Abbildung unten).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-523">Substitute the **accountName** value with your Azure Storage Service name and **accountKey** value with the key value found in the Azure Storage Service, in the Azure Portal (See Image below).</span></span> 
    >
    > ![Abrufen des kontoschlüssels](images/AzureLabs-Lab8-70.png)

7.  <span data-ttu-id="f0c1a-525">Fügen Sie nun die **Start()** und **Awake()** Methoden zum Initialisieren der Klasse.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-525">Now add the **Start()** and **Awake()** methods to initialize the class.</span></span>
...
8.  <span data-ttu-id="f0c1a-526">In der **TableToScene** Klasse, fügen Sie die Methode, die die Werte aus der Azure-Tabelle abrufen und diese verwenden, um die entsprechenden primitiven in der Szene zu erzeugen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-526">Within the **TableToScene** class, add the method that will retrieve the values from the Azure Table and use them to spawn the appropriate primitives in the scene.</span></span>
...
9.  <span data-ttu-id="f0c1a-527">Außerhalb der **TableToScene** -Klasse, müssen Sie die Klasse, die zum Serialisieren und Deserialisieren von der Anwendung verwendeten definieren die **Tabellenentitäten**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-527">Outside the **TableToScene** class, you need to define the class used by the application to serialize and deserialize the **Table Entities**.</span></span>
...
10. <span data-ttu-id="f0c1a-528">Stellen Sie sicher, dass Sie **speichern** vor dem Wechsel zurück zu Unity-Editor.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-528">Make sure you **Save** before going back to the Unity Editor.</span></span>

11. <span data-ttu-id="f0c1a-529">Klicken Sie auf die **Main Camera** aus der **Hierarchie** Bereich, sodass seine Eigenschaften im angezeigt werden die **Inspektor**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-529">Click the **Main Camera** from the **Hierarchy** panel, so that its properties appear in the **Inspector**.</span></span>

12. <span data-ttu-id="f0c1a-530">Mit der **Skripts** Ordner geöffnet ist, wählen Sie das Skript **TableToScene Datei** und ziehen Sie es auf die **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-530">With the **Scripts** folder open, select the script **TableToScene file** and drag it onto the **Main Camera**.</span></span> <span data-ttu-id="f0c1a-531">Das Ergebnis sollte wie folgt:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-531">The result should be as below:</span></span>

    ![Hauptkamera Skript hinzugefügt](images/AzureLabs-Lab8-71.png)

## <a name="chapter-10---create-the-cloudscene-class-in-the-desktop-unity-project"></a><span data-ttu-id="f0c1a-533">Kapitel 10 – erstellen Sie die CloudScene-Klasse in der Unity-Projekt für Desktop</span><span class="sxs-lookup"><span data-stu-id="f0c1a-533">Chapter 10 - Create the CloudScene class in the Desktop Unity Project</span></span>

<span data-ttu-id="f0c1a-534">Ist das zweite Skript, das Sie erstellen müssen **CloudScene**, die für verantwortlich ist:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-534">The second script you need to create is **CloudScene**, which is responsible for:</span></span>

-   <span data-ttu-id="f0c1a-535">Registrieren das Ereignis klicken, um dem Benutzer ermöglichen, Objekte in der Szene ziehen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-535">Registering the left-click event, to allow the user to drag objects around the scene.</span></span>

-   <span data-ttu-id="f0c1a-536">Serialisieren von Daten des Objekts, von diese Unity-Szene, und sie an der Azure-Funktions-App senden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-536">Serializing the object data from this Unity scene, and sending it to the Azure Function App.</span></span>

<span data-ttu-id="f0c1a-537">So erstellen Sie das zweite Skript:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-537">To create the second script:</span></span>

1.  <span data-ttu-id="f0c1a-538">Klicken Sie auf auf die **Skripts** Ordner, klicken Sie auf **erstellen**, **C\# Skript**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-538">Right-click inside the **Scripts** folder, click **Create**, **C\# Script**.</span></span> <span data-ttu-id="f0c1a-539">Nennen Sie das Skript **CloudScene**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-539">Name the script **CloudScene**</span></span>
    
    <span data-ttu-id="f0c1a-540">![neue c#-Skript](images/AzureLabs-Lab8-72.png)
    ![CloudScene umbenennen](images/AzureLabs-Lab8-73.png)</span><span class="sxs-lookup"><span data-stu-id="f0c1a-540">![new c# script](images/AzureLabs-Lab8-72.png)
![rename CloudScene](images/AzureLabs-Lab8-73.png)</span></span>

2.  <span data-ttu-id="f0c1a-541">Fügen Sie die folgenden Namespaces hinzu:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-541">Add the following namespaces:</span></span>
...
3.  <span data-ttu-id="f0c1a-542">Fügen Sie die folgenden Variablen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-542">Insert the following variables:</span></span>
...
4.  <span data-ttu-id="f0c1a-543">Ersetzen der **AzureFunctionEndpoint** Wert mit Ihrem Azure-Funktion-App-URL finden Sie in der Azure-Funktion App Service im Azure-Portal, wie in der folgenden Abbildung gezeigt:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-543">Substitute the **azureFunctionEndpoint** value with your Azure Function App URL found in the Azure Function App Service, in the Azure Portal, as shown in the image below:</span></span>

    ![Funktions-URL abrufen](images/AzureLabs-Lab8-74.png)

5.  <span data-ttu-id="f0c1a-545">Fügen Sie nun die **Start()** und **Awake()** Methoden zum Initialisieren der Klasse.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-545">Now add the **Start()** and **Awake()** methods to initialize the class.</span></span>
...
6.  <span data-ttu-id="f0c1a-546">In der **Update()** -Methode, fügen Sie folgenden Code, mit denen erkannt wird, die Mauseingabe und ziehen Sie, die wiederum "gameobjects" in der Szene verschoben wird.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-546">Within the **Update()** method, add the following code that will detect the mouse input and drag, which will in turn move GameObjects in the scene.</span></span> <span data-ttu-id="f0c1a-547">Wenn der Benutzer verfügt über Drag & Drop ein Objekt, es werden die Namen und die Koordinaten des Objekts an die Methode übergeben **UpdateCloudScene()** , ruft die den Azure-Funktions-App-Dienst, das die Azure-Tabelle und der Trigger aktualisiert die die Benachrichtigung.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-547">If the user has dragged and dropped an object, it will pass the name and coordinates of the object to the method **UpdateCloudScene()**, which will call the Azure Function App service, which will update the Azure table and trigger the notification.</span></span>
...
7.  <span data-ttu-id="f0c1a-548">Fügen Sie nun die **UpdateCloudScene()** Methode, wie unten gezeigt:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-548">Now add the **UpdateCloudScene()** method, as below:</span></span>
...
8.  <span data-ttu-id="f0c1a-549">Speichern Sie den Code und zurück zu Unity</span><span class="sxs-lookup"><span data-stu-id="f0c1a-549">Save the code and return to Unity</span></span>

9.  <span data-ttu-id="f0c1a-550">Ziehen Sie die **CloudScene** Skript auf die **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-550">Drag the **CloudScene** script onto the **Main Camera**.</span></span> 

    1. <span data-ttu-id="f0c1a-551">Klicken Sie auf die **Main Camera** aus der **Hierarchie** Bereich, sodass seine Eigenschaften im angezeigt werden die **Inspektor**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-551">Click the **Main Camera** from the **Hierarchy** panel, so that its properties appear in the **Inspector**.</span></span> 

    2. <span data-ttu-id="f0c1a-552">Mit der **Skripts** geöffnet ist, wählen die **CloudScene** Skript, und ziehen Sie es auf die **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-552">With the **Scripts** folder open, select the **CloudScene** script and drag it onto the **Main Camera**.</span></span> <span data-ttu-id="f0c1a-553">Das Ergebnis sollte wie folgt:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-553">The result should be as below:</span></span>

        > ![Ziehen Sie Cloud-Skript auf Hauptkamera](images/AzureLabs-Lab8-75.png)

## <a name="chapter-11---build-the-desktop-project-to-uwp"></a><span data-ttu-id="f0c1a-555">Kapitel 11: Erstellen Sie das Desktopprojekt UWP</span><span class="sxs-lookup"><span data-stu-id="f0c1a-555">Chapter 11 - Build the Desktop Project to UWP</span></span>

<span data-ttu-id="f0c1a-556">Alles, was Sie für den Unity-Abschnitt, der dieses Projekt wurde jetzt abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-556">Everything needed for the Unity section of this project has now been completed.</span></span>

1.  <span data-ttu-id="f0c1a-557">Navigieren Sie zu **Buildeinstellungen** (**Datei** > **Buildeinstellungen**).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-557">Navigate to **Build Settings** (**File** > **Build Settings**).</span></span>

2.  <span data-ttu-id="f0c1a-558">Von der **Buildeinstellungen** Fenster, klicken Sie auf **erstellen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-558">From the **Build Settings** window, click **Build**.</span></span>

    ![Buildprojekt](images/AzureLabs-Lab8-76.png)

3.  <span data-ttu-id="f0c1a-560">Ein **Datei-Explorer** Fenster wird Popup, dem Sie einen Speicherort für den Build aufgefordert werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-560">A **File Explorer** window will popup, prompting you for a location to Build.</span></span> <span data-ttu-id="f0c1a-561">Erstellen Sie einen neuen Ordner (indem Sie auf **neuer Ordner** in der oberen linken Ecke), und nennen Sie sie **erstellt**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-561">Create a new folder (by clicking **New Folder** in the top-left corner), and name it **BUILDS**.</span></span>

    ![neuen Ordner für build](images/AzureLabs-Lab8-77.png)

    1.  <span data-ttu-id="f0c1a-563">Öffnen Sie die neue **erstellt** Ordner, und erstellen Sie einen anderen Ordner (mit **neuer Ordner** einmal), und nennen Sie sie **NH\_Desktop\_App**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-563">Open the new **BUILDS** folder, and create another folder (using **New Folder** once more), and name it **NH\_Desktop\_App**.</span></span>

        ![Name des Ordners NH_Desktop_App](images/AzureLabs-Lab8-78.png)

    2.  <span data-ttu-id="f0c1a-565">Mit der **NH\_Desktop\_App** ausgewählten.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-565">With the **NH\_Desktop\_App** selected.</span></span> <span data-ttu-id="f0c1a-566">Klicken Sie auf **wählen Sie Ordner**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-566">click **Select Folder**.</span></span> <span data-ttu-id="f0c1a-567">Das Projekt wird eine Minute erstellen dauern.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-567">The project will take a minute or so to build.</span></span>

4.  <span data-ttu-id="f0c1a-568">Nach Build **Datei-Explorer** wird angezeigt, die Sie den Standort des neuen Projekts.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-568">Following build, **File Explorer** will appear showing you the location of your new project.</span></span> <span data-ttu-id="f0c1a-569">Nicht erforderlich, um sie zu öffnen, aber wie müssen Sie die andere erstellt Unity Projekt zuerst in den nächsten Kapiteln werden soll.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-569">No need to open it, though, as you need to create the other Unity project first, in the next few Chapters.</span></span>


## <a name="chapter-12---set-up-mixed-reality-unity-project"></a><span data-ttu-id="f0c1a-570">Kapitel 12: Einrichten von Mixed Reality Unity-Projekt</span><span class="sxs-lookup"><span data-stu-id="f0c1a-570">Chapter 12 - Set up Mixed Reality Unity Project</span></span>

<span data-ttu-id="f0c1a-571">Im folgenden ist ein typischer Eigenschaftensatz für die Entwicklung mit dem mixed Reality und daher ist eine gute Vorlage für andere Projekte.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-571">The following is a typical set up for developing with the mixed reality, and as such, is a good template for other projects.</span></span>

1.  <span data-ttu-id="f0c1a-572">Open **Unity** , und klicken Sie auf **neu**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-572">Open **Unity** and click **New**.</span></span>

    ![Neues Unity-Projekt](images/AzureLabs-Lab8-79.png)

2.  <span data-ttu-id="f0c1a-574">Sie müssen nun zum Bereitstellen eines Namen Unity-Projekt einfügen **UnityMRNotifHub**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-574">You will now need to provide a Unity Project name, insert **UnityMRNotifHub**.</span></span> <span data-ttu-id="f0c1a-575">Stellen Sie sicher, dass der Projekttyp nastaven NA hodnotu **3D**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-575">Make sure the project type is set to **3D**.</span></span> <span data-ttu-id="f0c1a-576">Legen Sie die **Speicherort** auf etwas für Sie geeignet (Denken Sie daran, näher an Stammverzeichnisse ist besser).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-576">Set the **Location** to somewhere appropriate for you (remember, closer to root directories is better).</span></span> <span data-ttu-id="f0c1a-577">Klicken Sie auf **projekterstellung**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-577">Then, click **Create project**.</span></span>

    ![name UnityMRNotifHub](images/AzureLabs-Lab8-80.png)

3.  <span data-ttu-id="f0c1a-579">Mit Unity geöffnet, es prüfen, ob der Standardwert ist **Skript-Editor** nastaven NA hodnotu **Visual Studio**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-579">With Unity open, it is worth checking the default **Script Editor** is set to **Visual Studio**.</span></span> <span data-ttu-id="f0c1a-580">Wechseln Sie zu **bearbeiten** > **Voreinstellungen** und navigieren Sie dann im neuen Fenster zu **externe Tools**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-580">Go to **Edit** > **Preferences** and then from the new window, navigate to **External Tools**.</span></span> <span data-ttu-id="f0c1a-581">Änderung **externen Skript-Editors** zu **Visual Studio 2017**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-581">Change **External Script Editor** to **Visual Studio 2017**.</span></span> <span data-ttu-id="f0c1a-582">Schließen der **Voreinstellungen** Fenster.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-582">Close the **Preferences** window.</span></span>

    ![externe-Editors in VS](images/AzureLabs-Lab8-81.png)

4.  <span data-ttu-id="f0c1a-584">Öffnen Sie als Nächstes **Datei** > **Buildeinstellungen** , und wechseln von der Plattform bereitgestellten **universelle Windows-Plattform**, durch Klicken auf die **Plattform wechseln**  Schaltfläche.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-584">Next, go to **File** > **Build Settings** and switch the platform to **Universal Windows Platform**, by clicking on the **Switch Platform** button.</span></span>

    ![Plattform für die UWP wechseln](images/AzureLabs-Lab8-82.png)

5.  <span data-ttu-id="f0c1a-586">Wechseln Sie zu **Datei** > **Buildeinstellungen** und stellen Sie sicher, dass:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-586">Go to **File** > **Build Settings** and make sure that:</span></span>

    1.  <span data-ttu-id="f0c1a-587">**Geräte** nastaven NA hodnotu **einem beliebigen Gerät**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-587">**Target Device** is set to **Any Device**</span></span>

        > <span data-ttu-id="f0c1a-588">Legen Sie für die Microsoft HoloLens **Zielgerät** zu *HoloLens*.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-588">For the Microsoft HoloLens, set **Target Device** to *HoloLens*.</span></span>

    2.  <span data-ttu-id="f0c1a-589">**Buildtyp** nastaven NA hodnotu **D3D**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-589">**Build Type** is set to **D3D**</span></span>

    3.  <span data-ttu-id="f0c1a-590">**SDK** nastaven NA hodnotu **zuletzt installierte**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-590">**SDK** is set to **Latest installed**</span></span>

    4.  <span data-ttu-id="f0c1a-591">**Visual Studio-Version** nastaven NA hodnotu **zuletzt installierte**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-591">**Visual Studio Version** is set to **Latest installed**</span></span>

    5.  <span data-ttu-id="f0c1a-592">**Erstellen und ausführen** nastaven NA hodnotu **lokalen Computer**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-592">**Build and Run** is set to **Local Machine**</span></span>

    6.  <span data-ttu-id="f0c1a-593">Hier lohnt sich die Szene speichern und mit dem Build hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-593">While here, it is worth saving the scene, and adding it to the build.</span></span>

        1. <span data-ttu-id="f0c1a-594">Hierzu **öffnen Szenen hinzufügen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-594">Do this by selecting **Add Open Scenes**.</span></span> <span data-ttu-id="f0c1a-595">Ein Speichern Fenster wird angezeigt.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-595">A save window will appear.</span></span>

            ![Hinzufügen von öffnen-Szenen](images/AzureLabs-Lab8-83.png)

        2. <span data-ttu-id="f0c1a-597">Erstellen einen neuen Ordner für, und alle zukünftigen, Szene, klicken Sie dann auf die **neuer Ordner** Schaltfläche zum Erstellen eines neuen Ordners, nennen Sie sie **Szenen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-597">Create a new folder for this, and any future, scene, then select the **New folder** button, to create a new folder, name it **Scenes**.</span></span>

            ![neuen Ordner "Szenen"](images/AzureLabs-Lab8-84.png)

        3. <span data-ttu-id="f0c1a-599">Öffnen Sie den neu erstellten **Szenen** Ordner, und klicken Sie dann in der **Dateiname:** Textfeld **NH\_MR\_Szene**, drücken Sie dann die  **Speichern Sie**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-599">Open your newly created **Scenes** folder, and then in the **File name:** text field, type **NH\_MR\_Scene**, then press **Save**.</span></span>

            ![neue Szene - NH_MR_Scene](images/AzureLabs-Lab8-85.png)

    7.  <span data-ttu-id="f0c1a-601">Die Einstellungen im verbleibenden **Buildeinstellungen**, sollte jetzt als Standard bleiben.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-601">The remaining settings, in **Build Settings**, should be left as default for now.</span></span>

6.  <span data-ttu-id="f0c1a-602">Klicken Sie in demselben Fenster auf die **Playereinstellungen** Schaltfläche Dies öffnet den entsprechenden Bereich im Bereich, in dem die **Inspektor** befindet.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-602">In the same window click on the **Player Settings** button, this will open the related panel in the space where the **Inspector** is located.</span></span>    

    ![Öffnen der playereinstellungen](images/AzureLabs-Lab8-86.png)

7.  <span data-ttu-id="f0c1a-604">In diesem Bereich sind müssen einige Einstellungen überprüft werden:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-604">In this panel, a few settings need to be verified:</span></span>

    1.  <span data-ttu-id="f0c1a-605">In der **Weitere Einstellungen** Registerkarte:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-605">In the **Other Settings** tab:</span></span>

        1.  <span data-ttu-id="f0c1a-606">**Scripting Runtime Version** muss **experimentell** (.NET 4.6 Äquivalent)</span><span class="sxs-lookup"><span data-stu-id="f0c1a-606">**Scripting Runtime Version** should be **Experimental** (.NET 4.6 Equivalent)</span></span>
        2.  <span data-ttu-id="f0c1a-607">**Back-End-Scripting** muss ***.NET***</span><span class="sxs-lookup"><span data-stu-id="f0c1a-607">**Scripting Backend** should be ***.NET***</span></span>
        3.  <span data-ttu-id="f0c1a-608">**API-Kompatibilitätsebene** muss **.NET 4.6**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-608">**API Compatibility Level** should be **.NET 4.6**</span></span>

            ![API-Kompatibilität](images/AzureLabs-Lab8-87.png)

    2.  <span data-ttu-id="f0c1a-610">Weiter unten im Bereich mit in **XR-Einstellungen** (finden Sie unten **Veröffentlichungseinstellungen**), Teilstriche **virtuelle Realität unterstützt**, stellen Sie sicher, dass die **Windows Mixed Reality-SDK**  wird hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="f0c1a-610">Further down the panel, in **XR Settings** (found below **Publish Settings**), tick **Virtual Reality Supported**, make sure the **Windows Mixed Reality SDK** is added</span></span>

        ![Aktualisieren der Xr-Einstellungen](images/AzureLabs-Lab8-88.png)        

    3.  <span data-ttu-id="f0c1a-612">In der **Veröffentlichungseinstellungen** Registerkarte **Funktionen**, prüfen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-612">Within the **Publishing Settings** tab, under **Capabilities**, heck:</span></span>

        - <span data-ttu-id="f0c1a-613">**InternetClient**</span><span class="sxs-lookup"><span data-stu-id="f0c1a-613">**InternetClient**</span></span>           

            ![Takt-Internetclient](images/AzureLabs-Lab8-89.png)

8.  <span data-ttu-id="f0c1a-615">Im **Buildeinstellungen**, **Unity C# Projekte** ist nicht mehr abgeblendet: Aktivieren Sie das Kontrollkästchen neben dieser.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-615">Back in **Build Settings**, **Unity C# Projects** is no longer greyed out: tick the checkbox next to this.</span></span>

9.  <span data-ttu-id="f0c1a-616">Schließen Sie mit diesen Änderungen durchgeführt, und das Build Settings-Fenster.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-616">With these changes done, close the Build Settings window.</span></span>

10. <span data-ttu-id="f0c1a-617">Speichern Sie Ihre Szene und das Projekt **Datei** > **Szene speichern / File** > **Projekt speichern**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-617">Save your Scene and Project **File** > **Save Scene / File** > **Save Project**.</span></span>

    > [!IMPORTANT]
    > <span data-ttu-id="f0c1a-618">Wenn Sie, überspringen möchten der *Unity einrichten* für dieses Projekt (mixed Reality-App)-Komponente weiterhin direkt in Code, und Sie gerne [Herunterladen dieser .unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-MR.unitypackage), importieren Sie es in Ihr Projekt als eine [ **Custom Package**](https://docs.unity3d.com/Manual/AssetPackages.html), und klicken Sie dann eine Fortsetzung [Kapitel 14](#chapter-14---creating-the-tabletoscene-class-in-the-mixed-reality-unity-project).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-618">If you wish to skip the *Unity Set up* component for this project (mixed reality App), and continue straight into code, feel free to [download this .unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-MR.unitypackage), import it into your project as a [**Custom Package**](https://docs.unity3d.com/Manual/AssetPackages.html), and then continue from [Chapter 14](#chapter-14---creating-the-tabletoscene-class-in-the-mixed-reality-unity-project).</span></span> <span data-ttu-id="f0c1a-619">Sie müssen weiterhin die Skriptkomponenten hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-619">You will still need to add the script components.</span></span>

### <a name="chapter-13---importing-the-dlls-in-the-mixed-reality-unity-project"></a><span data-ttu-id="f0c1a-620">Kapitel 13 – Importieren von die DLLs im Unity-Projekts Mixed Reality</span><span class="sxs-lookup"><span data-stu-id="f0c1a-620">Chapter 13 - Importing the DLLs in the Mixed Reality Unity Project</span></span>

<span data-ttu-id="f0c1a-621">Sie werden Azure Storage für Unity-Bibliothek verwenden (das das .net SDK für Azure verwendet wird).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-621">You will be using Azure Storage for Unity library (which uses the .Net SDK for Azure).</span></span> <span data-ttu-id="f0c1a-622">Führen Sie dies [Link zur Verwendung von Azure Storage mit Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-622">Please follow this [link on how to use Azure Storage with Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span></span>
<span data-ttu-id="f0c1a-623">Es befindet sich derzeit ein bekanntes Problem in Unity-Plug-Ins neu konfiguriert werden, nach dem Import erfordert.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-623">There is currently a known issue in Unity which requires plugins to be reconfigured after import.</span></span> <span data-ttu-id="f0c1a-624">Diese Schritte (4 bis 7 in diesem Abschnitt) ist nicht mehr erforderlich, nachdem der Fehler behoben wurde.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-624">These steps (4 - 7 in this section) will no longer be required after the bug has been resolved.</span></span>

<span data-ttu-id="f0c1a-625">Um das SDK in Ihr eigenes Projekt zu importieren, stellen Sie sicher, dass Sie heruntergeladen haben, die neueste Version [.unitypackage](https://aka.ms/azstorage-unitysdk).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-625">To import the SDK into your own project, make sure you have downloaded the latest [.unitypackage](https://aka.ms/azstorage-unitysdk).</span></span> <span data-ttu-id="f0c1a-626">Führen Sie anschließend folgende Schritte aus:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-626">Then, do the following:</span></span>

1.  <span data-ttu-id="f0c1a-627">Hinzufügen der .unitypackage, die Sie aus den oben genannten, in Unity mithilfe heruntergeladen der **Assets** > **Paket importieren** > **Custom Package** Menüoption .</span><span class="sxs-lookup"><span data-stu-id="f0c1a-627">Add the .unitypackage you downloaded from the above, to Unity by using the **Assets** > **Import Package** > **Custom Package** menu option.</span></span>

2.  <span data-ttu-id="f0c1a-628">In der **Unity-Paket importieren** Feld angezeigt, alles unter können Sie auswählen **-Plug-Ins** > **Storage**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-628">In the **Import Unity Package** box that pops up, you can select everything under **Plugin** > **Storage**.</span></span>

    ![Paket importieren](images/AzureLabs-Lab8-90.png)

3.  <span data-ttu-id="f0c1a-630">Klicken Sie auf die **Import** , um die Elemente zu Ihrem Projekt hinzuzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-630">Click the **Import** button to add the items to your project.</span></span>

4.  <span data-ttu-id="f0c1a-631">Wechseln Sie zu der **Storage** Unterordner **-Plug-Ins** im Projekt anzuzeigen, und wählen Sie die folgenden Plug-Ins *nur*:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-631">Go to the **Storage** folder under **Plugins** in the Project view and select the following plugins *only*:</span></span>

    -   <span data-ttu-id="f0c1a-632">Microsoft.Data.Edm</span><span class="sxs-lookup"><span data-stu-id="f0c1a-632">Microsoft.Data.Edm</span></span>
    -   <span data-ttu-id="f0c1a-633">Microsoft.Data.OData</span><span class="sxs-lookup"><span data-stu-id="f0c1a-633">Microsoft.Data.OData</span></span>
    -   <span data-ttu-id="f0c1a-634">Microsoft.WindowsAzure.Storage</span><span class="sxs-lookup"><span data-stu-id="f0c1a-634">Microsoft.WindowsAzure.Storage</span></span>
    -   <span data-ttu-id="f0c1a-635">Newtonsoft.Json</span><span class="sxs-lookup"><span data-stu-id="f0c1a-635">Newtonsoft.Json</span></span>
    -   <span data-ttu-id="f0c1a-636">System.Spatial</span><span class="sxs-lookup"><span data-stu-id="f0c1a-636">System.Spatial</span></span>

    ![Wählen Sie-Plug-Ins](images/AzureLabs-Lab8-91.png)

5.  <span data-ttu-id="f0c1a-638">Mit *bestimmte Plug-Ins* ausgewählt, **deaktivieren** **Any Platform** und **deaktivieren** **WSAPlayer** Klicken Sie dann auf **übernehmen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-638">With *these specific plugins* selected, **uncheck** **Any Platform** and **uncheck** **WSAPlayer** then click **Apply**.</span></span>

    ![Anwenden von plattformänderungen](images/AzureLabs-Lab8-92.png)

    > [!NOTE] 
    > <span data-ttu-id="f0c1a-640">Markieren Sie diese bestimmten Plug-Ins, die nur im Unity-Editor verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-640">You are marking these particular plugins to only be used in the Unity Editor.</span></span> <span data-ttu-id="f0c1a-641">Dies ist, da es gibt verschiedene Versionen der gleichen Plug-Ins in das WSA-Ordner, der verwendet wird und nachdem das Projekt aus Unity exportiert werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-641">This is because there are different versions of the same plugins in the WSA folder that will be used after the project is exported from Unity.</span></span>

6.  <span data-ttu-id="f0c1a-642">In der **Storage** -Plug-in-Ordner, wählen Sie nur:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-642">In the **Storage** plugin folder, select only:</span></span>

    -   <span data-ttu-id="f0c1a-643">Microsoft.Data.Services.Client</span><span class="sxs-lookup"><span data-stu-id="f0c1a-643">Microsoft.Data.Services.Client</span></span>

        ![Data Services-Client auswählen](images/AzureLabs-Lab8-93.png)

7.  <span data-ttu-id="f0c1a-645">Überprüfen Sie die **Don't Prozess** Feld **Plattformeinstellungen** , und klicken Sie auf **übernehmen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-645">Check the **Don't Process** box under **Platform Settings** and click **Apply**.</span></span>

    ![nicht verarbeiten](images/AzureLabs-Lab8-94.png)

    > [!NOTE] 
    > <span data-ttu-id="f0c1a-647">Sie werden dieses Plug-in "Nicht verarbeiten" markieren, da die Unity-Assembly-Patcher schwierigkeiten beim Verarbeiten dieses Plug-in ist.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-647">You are marking this plugin "Don't process" because the Unity assembly patcher has difficulty processing this plugin.</span></span> <span data-ttu-id="f0c1a-648">Das Plug-in funktioniert weiterhin, auch wenn es nicht verarbeitet ist.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-648">The plugin will still work even though it isn't processed.</span></span>

## <a name="chapter-14---creating-the-tabletoscene-class-in-the-mixed-reality-unity-project"></a><span data-ttu-id="f0c1a-649">Kapitel 14: Erstellen der TableToScene-Klasse in mixed Reality Unity-Projekts</span><span class="sxs-lookup"><span data-stu-id="f0c1a-649">Chapter 14 - Creating the TableToScene class in the mixed reality Unity project</span></span>

<span data-ttu-id="f0c1a-650">Die **TableToScene** Klasse ist identisch mit dem im erläutert [Kapitel 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-650">The **TableToScene** class is identical to the one explained in [Chapter 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span></span> <span data-ttu-id="f0c1a-651">Erstellen Sie die gleiche Klasse in gemischten Unity-Projekt die gleichen Schritte, in erläutert Wirklichkeit [Kapitel 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-651">Create the same class in the mixed reality Unity Project following the same procedure explained in [Chapter 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span></span>

<span data-ttu-id="f0c1a-652">Nachdem Sie in diesem Kapitel, beide haben Ihre **Unity-Projekte** wird diese Klasse, die auf den Main Camera eingerichtet haben.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-652">Once you have completed this Chapter, both of your **Unity Projects** will have this class set up on the Main Camera.</span></span>

## <a name="chapter-15---creating-the-notificationreceiver-class-in-the-mixed-reality-unity-project"></a><span data-ttu-id="f0c1a-653">Kapitel 15: Erstellen der NotificationReceiver-Klasse in Mixed Reality Unity-Projekts</span><span class="sxs-lookup"><span data-stu-id="f0c1a-653">Chapter 15 - Creating the NotificationReceiver class in the Mixed Reality Unity Project</span></span>

<span data-ttu-id="f0c1a-654">Ist das zweite Skript, das Sie erstellen müssen **NotificationReceiver**, die für verantwortlich ist:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-654">The second script you need to create is **NotificationReceiver**, which is responsible for:</span></span>

-   <span data-ttu-id="f0c1a-655">Beim Registrieren der app beim Notification Hub bei der Initialisierung.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-655">Registering the app with the Notification Hub at initialization.</span></span>
-   <span data-ttu-id="f0c1a-656">Von den Notification Hub-Benachrichtigungen überwacht.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-656">Listening to notifications coming from the Notification Hub.</span></span>
-   <span data-ttu-id="f0c1a-657">Deserialisiert die Daten des Objekts aus dem empfangenen Benachrichtigungen an.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-657">Deserializing the object data from received notifications.</span></span>
-   <span data-ttu-id="f0c1a-658">Verschieben Sie die "gameobjects" in der Szene, basierend auf den deserialisierten Daten.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-658">Move the GameObjects in the scene, based on the deserialized data.</span></span>

<span data-ttu-id="f0c1a-659">Zum Erstellen der **NotificationReceiver** Skript:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-659">To create the **NotificationReceiver** script:</span></span>

1.  <span data-ttu-id="f0c1a-660">Klicken Sie auf auf die **Skripts** Ordner, klicken Sie auf **erstellen**, **C\# Skript**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-660">Right-click inside the **Scripts** folder, click **Create**, **C\# Script**.</span></span> <span data-ttu-id="f0c1a-661">Nennen Sie das Skript **NotificationReceiver**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-661">Name the script **NotificationReceiver**.</span></span>

    <span data-ttu-id="f0c1a-662">![Erstellen Sie neue c#-Skript](images/AzureLabs-Lab8-95.png)
    ![NotificationReceiver Namen](images/AzureLabs-Lab8-96.png)</span><span class="sxs-lookup"><span data-stu-id="f0c1a-662">![create new c# script](images/AzureLabs-Lab8-95.png)
![name it NotificationReceiver](images/AzureLabs-Lab8-96.png)</span></span>

2.  <span data-ttu-id="f0c1a-663">Doppelklicken Sie auf das Skript aus, um ihn zu öffnen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-663">Double click on the script to open it.</span></span>

3.  <span data-ttu-id="f0c1a-664">Fügen Sie die folgenden Namespaces hinzu:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-664">Add the following namespaces:</span></span>
...
4.  <span data-ttu-id="f0c1a-665">Fügen Sie die folgenden Variablen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-665">Insert the following variables:</span></span>
...
5.  <span data-ttu-id="f0c1a-666">Ersetzen der **HubName** Wert durch den Namen Ihres Notification Hubs-Dienst und **HubListenEndpoint** Wert mit den Endpunktwert finden Sie in der Registerkarte "Zugriffsrichtlinien" Azure Notification Hubs-Dienst, in der Azure-Portal (siehe Abbildung unten).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-666">Substitute the **hubName** value with your Notification Hub Service name, and **hubListenEndpoint** value with the endpoint value found in the Access Policies tab, Azure Notification Hub Service, in the Azure Portal (see image below).</span></span>

    ![Einfügen von Notification Hubs-Richtlinie-Endpunkt](images/AzureLabs-Lab8-97.png)

6.  <span data-ttu-id="f0c1a-668">Fügen Sie nun die **Start()** und **Awake()** Methoden zum Initialisieren der Klasse.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-668">Now add the **Start()** and **Awake()** methods to initialize the class.</span></span>
...
7.  <span data-ttu-id="f0c1a-669">Hinzufügen der **WaitForNotification** Methode, um die app Benachrichtigungen aus der Bibliothek der Notification Hub empfangen werden, ohne mit den Hauptthread ein Konflikt besteht zuzulassen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-669">Add the **WaitForNotification** method to allow the app to receive notifications from the Notification Hub Library without clashing with the Main Thread:</span></span>
...
8.  <span data-ttu-id="f0c1a-670">Die folgende Methode, **InitNotificationAsync()** , registrieren Sie die Anwendung wird mit dem Notification Hub-Dienst bei der Initialisierung.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-670">The following method, **InitNotificationAsync()**, will register the application with the notification Hub Service at initialization.</span></span> <span data-ttu-id="f0c1a-671">Der Code ist auskommentiert, wie Unity nicht zum Erstellen des Projekts kann.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-671">The code is commented out as Unity will not be able to Build the project.</span></span> <span data-ttu-id="f0c1a-672">Sie werden die Kommentare entfernen, wenn Sie das Azure-Messaging-Nuget-Paket in Visual Studio importieren.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-672">You will remove the comments when you import the Azure Messaging Nuget package in Visual Studio.</span></span>
...
9.  <span data-ttu-id="f0c1a-673">Der folgende Handler, **Kanal\_PushNotificationReceived()** , wird jedes Mal, wenn eine Benachrichtigung empfangen wird ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-673">The following handler, **Channel\_PushNotificationReceived()**, will be triggered every time a notification is received.</span></span> <span data-ttu-id="f0c1a-674">Es wird die Benachrichtigung Deserialisieren der wird die Azure Table Storage-Entität, die auf die Desktop-Anwendung verschoben wurden, und klicken Sie dann das entsprechende "gameobject" in der Szene MR an dieselbe Position verschieben.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-674">It will deserialize the notification, which will be the Azure Table Entity that has been moved on the Desktop Application, and then move the corresponding GameObject in the MR scene to the same position.</span></span> 
    
    > [!IMPORTANT]
    > <span data-ttu-id="f0c1a-675">Der Code ist auskommentiert, da der Code die Azure-Messaging-Bibliothek verweist, die Sie nach dem Erstellen des Nuget-Paket-Managers in Visual Studio mit Unity-Projekts hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-675">The code is commented out because the code references the Azure Messaging library, which you will add after building the Unity project using the Nuget Package Manager, within Visual Studio.</span></span> <span data-ttu-id="f0c1a-676">Daher wird das Unity-Projekt nicht erstellen, können es sei denn, er ist auskommentiert ist. Beachten Sie, sollten Sie Ihr Projekt erstellen und anschließend zu Unity zurückgeben möchten, müssen Sie **wieder mit Kommentaren versehen** dieses Codes.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-676">As such, the Unity project will not be able to build, unless it is commented out. Be aware, that should you build your project, and then wish to return to Unity, you will need to **re-comment** that code.</span></span>
...
10. <span data-ttu-id="f0c1a-677">Denken Sie daran, um die Änderungen zu speichern, vor dem Wechsel zurück zu Unity-Editor.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-677">Remember to save your changes before going back to the Unity Editor.</span></span>

11. <span data-ttu-id="f0c1a-678">Klicken Sie auf die **Main Camera** aus der **Hierarchie** Bereich, sodass seine Eigenschaften im angezeigt werden die **Inspektor**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-678">Click the **Main Camera** from the **Hierarchy** panel, so that its properties appear in the **Inspector**.</span></span>

12. <span data-ttu-id="f0c1a-679">Mit der **Skripts** geöffnet ist, wählen die **NotificationReceiver** Skript, und ziehen Sie es auf die **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-679">With the **Scripts** folder open, select the **NotificationReceiver** script and drag it onto the **Main Camera**.</span></span> <span data-ttu-id="f0c1a-680">Das Ergebnis sollte wie folgt:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-680">The result should be as below:</span></span>

    ![Ziehen Sie Empfänger Benachrichtigungsskript an Kamera](images/AzureLabs-Lab8-98.png)

    > [!NOTE]
    > <span data-ttu-id="f0c1a-682">Wenn Sie dies für die Microsoft HoloLens entwickeln, müssen Sie zum Aktualisieren der **Main Camera**des *Kamera* -Komponente, damit:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-682">If you are developing this for the Microsoft HoloLens, you will need to update the **Main Camera**'s *Camera* component, so that:</span></span>
    > - <span data-ttu-id="f0c1a-683">Flags zu löschen: Volltonfarbe</span><span class="sxs-lookup"><span data-stu-id="f0c1a-683">Clear Flags: Solid Color</span></span>
    > - <span data-ttu-id="f0c1a-684">Hintergrund: Schwarz</span><span class="sxs-lookup"><span data-stu-id="f0c1a-684">Background: Black</span></span>

## <a name="chapter-16---build-the-mixed-reality-project-to-uwp"></a><span data-ttu-id="f0c1a-685">Kapitel 16 – erstellen Sie das Mixed Reality-Projekt auf UWP</span><span class="sxs-lookup"><span data-stu-id="f0c1a-685">Chapter 16 - Build the Mixed Reality Project to UWP</span></span>

<span data-ttu-id="f0c1a-686">In diesem Kapitel ist identisch mit der Prozess für das vorherige Projekt zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-686">This Chapter is identical to build process for the previous project.</span></span> <span data-ttu-id="f0c1a-687">Alles, was Sie für den Unity-Abschnitt, der dieses Projekt wurde jetzt abgeschlossen daher ist es Zeit für die Erstellung von Unity.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-687">Everything needed for the Unity section of this project has now been completed, so it is time to build it from Unity.</span></span>

1.  <span data-ttu-id="f0c1a-688">Navigieren Sie zu **Buildeinstellungen** ( **Datei** > **Buildeinstellungen** ).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-688">Navigate to **Build Settings** ( **File** > **Build Settings** ).</span></span>

2.  <span data-ttu-id="f0c1a-689">Von der **Buildeinstellungen** Menü, stellen Sie sicher **Unity C# Projekte**\* ist (sodass Sie so bearbeiten Sie die Skripts in diesem Projekt nach dem Build).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-689">From the **Build Settings** menu, ensure **Unity C# Projects**\* is ticked (which will allow you to edit the scripts in this project, after build).</span></span>

3.  <span data-ttu-id="f0c1a-690">Nachdem dies geschehen ist, klicken Sie auf **erstellen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-690">After this is done, click **Build**.</span></span>

    ![Buildprojekt](images/AzureLabs-Lab8-99.png)

4.  <span data-ttu-id="f0c1a-692">Ein **Datei-Explorer** Fenster wird Popup, dem Sie einen Speicherort für den Build aufgefordert werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-692">A **File Explorer** window will popup, prompting you for a location to Build.</span></span> <span data-ttu-id="f0c1a-693">Erstellen Sie einen neuen Ordner (indem Sie auf **neuer Ordner** in der oberen linken Ecke), und nennen Sie sie **erstellt**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-693">Create a new folder (by clicking **New Folder** in the top-left corner), and name it **BUILDS**.</span></span>

    ![Erstellen Sie Ordner "Builds"](images/AzureLabs-Lab8-100.png)

    1.  <span data-ttu-id="f0c1a-695">Öffnen Sie die neue **erstellt** Ordner, und erstellen Sie einen anderen Ordner (mit **neuer Ordner** einmal), und nennen Sie sie **NH\_MR\_App**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-695">Open the new **BUILDS** folder, and create another folder (using **New Folder** once more), and name it **NH\_MR\_App**.</span></span>

        ![Erstellen Sie NH_MR_Apps-Ordner](images/AzureLabs-Lab8-101.png)

    2.  <span data-ttu-id="f0c1a-697">Mit der **NH\_MR\_App** ausgewählten.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-697">With the **NH\_MR\_App** selected.</span></span> <span data-ttu-id="f0c1a-698">Klicken Sie auf **wählen Sie Ordner**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-698">click **Select Folder**.</span></span> <span data-ttu-id="f0c1a-699">Das Projekt wird eine Minute erstellen dauern.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-699">The project will take a minute or so to build.</span></span>

5.  <span data-ttu-id="f0c1a-700">Folgen den Build, eine **Datei-Explorer** Fenster wird geöffnet, an der Position des neuen Projekts.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-700">Following the build, a **File Explorer** window will open at the location of your new project.</span></span>



## <a name="chapter-17---add-nuget-packages-to-the-unitymrnotifhub-solution"></a><span data-ttu-id="f0c1a-701">Kapitel 17: Hinzufügen von NuGet-Pakete der Projektmappe UnityMRNotifHub</span><span class="sxs-lookup"><span data-stu-id="f0c1a-701">Chapter 17 - Add NuGet packages to the UnityMRNotifHub Solution</span></span>

> [!WARNING] 
> <span data-ttu-id="f0c1a-702">Bitte denken Sie daran, dass sobald Sie die folgenden NuGet-Pakete hinzufügen (und entfernen Sie den Code in den nächsten [Kapitel](#chapter-18---edit-unitymrnotifhub-application-notificationreceiver-class)), der Code, wenn in der Unity-Projekt erneut geöffnet werden Fehler angezeigt.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-702">Please remember that, once you add the following NuGet Packages (and uncomment the code in the next [Chapter](#chapter-18---edit-unitymrnotifhub-application-notificationreceiver-class)), the Code, when reopened within the Unity Project, will present errors.</span></span> <span data-ttu-id="f0c1a-703">Wenn Sie möchten, wechseln zurück und weiter im Unity-Editor bearbeiten, müssen Sie Errosome Code kommentieren, und klicken Sie dann kommentieren es später noch Mal, wenn Sie in Visual Studio sind.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-703">If you wish to go back and continue editing in the Unity Editor, you will need comment that errosome code, and then uncomment again later, once you are back in Visual Studio.</span></span> 

<span data-ttu-id="f0c1a-704">Sobald der mixed Reality-Build abgeschlossen wurde, navigieren Sie zu dem mixed Reality-Projekt, das Sie erstellt, und doppelklicken auf die Projektmappendatei (.sln) in diesem Ordner, um die Projektmappe mit Visual Studio 2017 geöffnet.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-704">Once the mixed reality build has been completed, navigate to the mixed reality project, which you built, and double click on the solution (.sln) file within that folder, to open your solution with Visual Studio 2017.</span></span>
<span data-ttu-id="f0c1a-705">Sie müssen sich jetzt hinzufügen der **WindowsAzure.Messaging.managed** NuGet-Paket; Dies ist eine Bibliothek, die zum Empfangen von Benachrichtigungen vom Notification Hub verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-705">You will now need to add the **WindowsAzure.Messaging.managed** NuGet package; this is a library that is used to receive Notifications from the Notification Hub.</span></span>

<span data-ttu-id="f0c1a-706">So importieren Sie das NuGet-Paket:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-706">To import the NuGet package:</span></span>

1.  <span data-ttu-id="f0c1a-707">In der **Projektmappen-Explorer**, klicken Sie mit der rechten Maustaste auf die Projektmappe</span><span class="sxs-lookup"><span data-stu-id="f0c1a-707">In the **Solution Explorer**, right click on your Solution</span></span>

2.  <span data-ttu-id="f0c1a-708">Klicken Sie auf **NuGet-Pakete verwalten**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-708">Click on **Manage NuGet Packages**.</span></span>

    ![Öffnen Sie den Nuget-manager](images/AzureLabs-Lab8-102.png)

3.  <span data-ttu-id="f0c1a-710">Wählen Sie die ***Durchsuchen*** Registerkarte und suchen Sie nach **WindowsAzure.Messaging.managed**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-710">Select the ***Browse*** tab and search for **WindowsAzure.Messaging.managed**.</span></span>

    ![Windows Azure-messaging-Paket zu finden](images/AzureLabs-Lab8-103.png)

4.  <span data-ttu-id="f0c1a-712">Wählen Sie das Ergebnis (wie unten gezeigt), und wählen Sie im Fenster auf der rechten Seite das Kontrollkästchen neben **Projekt**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-712">Select the result (as shown below), and in the window to the right, select the checkbox next to **Project**.</span></span> <span data-ttu-id="f0c1a-713">Dies wird setzen einen Teilstrich in das Kontrollkästchen neben **Projekt**, sowie das Kontrollkästchen neben der **Assembly-CSharp** und **UnityMRNotifHub** Projekt.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-713">This will place a tick in the checkbox next to **Project**, along with the checkbox next to the **Assembly-CSharp** and **UnityMRNotifHub** project.</span></span>

    ![Aktivieren Sie alle Projekte](images/AzureLabs-Lab8-104.png)

5.  <span data-ttu-id="f0c1a-715">Die ursprünglich bereitgestellte Version **möglicherweise nicht** mit diesem Projekt kompatibel sein.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-715">The version initially provided **may not** be compatible with this project.</span></span> <span data-ttu-id="f0c1a-716">Aus diesem Grund, klicken Sie auf das Dropdownmenü neben **Version**, und klicken Sie auf **Version 0.1.7.9**, klicken Sie dann auf **installieren**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-716">Therefore, click on the dropdown menu next to **Version**, and click **Version 0.1.7.9**, then click **Install**.</span></span>

6.  <span data-ttu-id="f0c1a-717">Installieren das NuGet-Paket ist jetzt beendet.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-717">You have now finished installing the NuGet package.</span></span> <span data-ttu-id="f0c1a-718">Suchen Sie den kommentierten Code, der Sie eingegeben, in haben der **NotificationReceiver** Klasse, und die Kommentare entfernen...</span><span class="sxs-lookup"><span data-stu-id="f0c1a-718">Find the commented code you entered in the **NotificationReceiver** class and remove the comments..</span></span>



## <a name="chapter-18---edit-unitymrnotifhub-application-notificationreceiver-class"></a><span data-ttu-id="f0c1a-719">Kapitel 18 – bearbeiten UnityMRNotifHub-Anwendung, NotificationReceiver-Klasse</span><span class="sxs-lookup"><span data-stu-id="f0c1a-719">Chapter 18 - Edit UnityMRNotifHub application, NotificationReceiver class</span></span>

<span data-ttu-id="f0c1a-720">Folgende hinzugefügt haben die **NuGet-Pakete**, müssen Sie *auskommentierung* Teil des Codes in der **NotificationReceiver** Klasse.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-720">Following having added the **NuGet Packages**, you will need to *uncomment* some of the code within the **NotificationReceiver** class.</span></span>

<span data-ttu-id="f0c1a-721">Dazu zählen:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-721">This includes:</span></span>

1. <span data-ttu-id="f0c1a-722">Der Namespace am Anfang:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-722">The namespace at the top:</span></span>

    ```csharp
    using Microsoft.WindowsAzure.Messaging;
    ```

2. <span data-ttu-id="f0c1a-723">Sämtlichen Code innerhalb der **InitNotificationsAsync()** Methode:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-723">All the code within the **InitNotificationsAsync()** method:</span></span>
...
> [!WARNING]
> <span data-ttu-id="f0c1a-724">Der obige Code enthält einen Kommentar: Stellen Sie sicher, dass Sie nicht versehentlich haben *unkommentierten* , der Kommentar (wie der Code nicht kompiliert, wenn man!).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-724">The code above has a comment in it: ensure that you have not accidentally *uncommented* that comment (as the code will not compile if you have!).</span></span>

3. <span data-ttu-id="f0c1a-725">Und schließlich die **Channel_PushNotificationReceived** Ereignis:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-725">And, lastly, the **Channel_PushNotificationReceived** event:</span></span>
...
<span data-ttu-id="f0c1a-726">Mit diesen auskommentiert werden können stellen Sie sicher, dass Sie speichern, und fahren Sie mit der im nächsten Kapitel.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-726">With these uncommented, ensure that you save, and then proceed to the next Chapter.</span></span>

## <a name="chapter-19---associate-the-mixed-reality-project-to-the-store-app"></a><span data-ttu-id="f0c1a-727">Kapitel 19: Ordnen Sie die mixed Reality-Projekt auf die Store-app</span><span class="sxs-lookup"><span data-stu-id="f0c1a-727">Chapter 19 - Associate the mixed reality project to the Store app</span></span>

<span data-ttu-id="f0c1a-728">Sie müssen jetzt Zuordnen der **mixed Reality** Projekt, um die Store-App, die Sie am Anfang des Labs in erstellt.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-728">You now need to associate the **mixed reality** project to the Store App you created in at the start of the lab.</span></span>

1.  <span data-ttu-id="f0c1a-729">Öffnen Sie die Projektmappe.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-729">Open the solution.</span></span>

2.  <span data-ttu-id="f0c1a-730">Klicken Sie mit der rechten Maustaste auf die UWP-app-Projekt im Projektmappen-Explorer-Bereich, der zum Aufrufen **Store**, und **App mit dem Store verknüpfen...** .</span><span class="sxs-lookup"><span data-stu-id="f0c1a-730">Right click on the UWP app Project in the Solution Explorer panel, the go to **Store**, and **Associate App with the Store...**.</span></span>

    ![Öffnen Sie die Store-Verknüpfung](images/AzureLabs-Lab8-105.png)

3.  <span data-ttu-id="f0c1a-732">Ein neues Fenster wird angezeigt namens **zuordnen Ihrer Anwendung die Windows Store**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-732">A new window will appear called **Associate Your App with the Windows Store**.</span></span> <span data-ttu-id="f0c1a-733">Klicken Sie auf **Weiter**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-733">Click **Next**.</span></span>

    ![Wechseln Sie zum nächsten Bildschirm](images/AzureLabs-Lab8-106.png)

4.  <span data-ttu-id="f0c1a-735">Es lädt alle Anwendungen, die das Konto, das Sie sich angemeldet haben zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-735">It will load up all the Applications associated with the Account which you have logged in.</span></span> <span data-ttu-id="f0c1a-736">Wenn Sie nicht mit Ihrem Konto angemeldet sind, können Sie **anmelden** auf dieser Seite.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-736">If you are not logged in to your account, you can **Log In** on this page.</span></span>

5.  <span data-ttu-id="f0c1a-737">Suchen der **Store-App-Namen** , die Sie zu Beginn dieses Tutorials erstellt, und wählen Sie ihn.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-737">Find the **Store App name** that you created at the start of this tutorial and select it.</span></span> <span data-ttu-id="f0c1a-738">Klicken Sie dann auf **Weiter**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-738">Then click **Next**.</span></span>

    ![Suchen Sie, und wählen Sie Ihren Store-Namen](images/AzureLabs-Lab8-107.png)

6.  <span data-ttu-id="f0c1a-740">Klicken Sie auf **zuordnen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-740">Click **Associate**.</span></span>

    ![Verknüpfen Sie die app](images/AzureLabs-Lab8-108.png)

7.  <span data-ttu-id="f0c1a-742">Ihre App ist nun **zugeordnete** mit der Store-App.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-742">Your App is now **Associated** with the Store App.</span></span> <span data-ttu-id="f0c1a-743">Dies ist zum Aktivieren von Benachrichtigungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-743">This is necessary for enabling Notifications.</span></span>

## <a name="chapter-20---deploy-unitymrnotifhub-and-unitydesktopnotifhub-applications"></a><span data-ttu-id="f0c1a-744">Kapitel 20: UnityMRNotifHub und UnityDesktopNotifHub Anwendungen bereitstellen</span><span class="sxs-lookup"><span data-stu-id="f0c1a-744">Chapter 20 - Deploy UnityMRNotifHub and UnityDesktopNotifHub applications</span></span>

<span data-ttu-id="f0c1a-745">In diesem Kapitel kann einfacher, mit zwei Personen sein, wie das Ergebnis enthält sowohl apps, die ausgeführt wird, eine Ausführung auf Ihrem Desktop-Computer und der andere in Ihrem immersive Kopfhörer.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-745">This Chapter may be easier with two people, as the result will include both apps running, one running on your computer Desktop, and the other within your immersive headset.</span></span>

<span data-ttu-id="f0c1a-746">Die immersive Kopfhörer app wartet darauf, um Änderungen an der Szene (Position ändert sich von der lokalen "gameobjects") zu erhalten, und die Desktop-app wird werden Änderungen an ihren lokalen Szene (Position ändert), die an die MR app gemeinsam genutzt werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-746">The immersive headset app is waiting to receive changes to the scene (position changes of the local GameObjects), and the Desktop app will be making changes to their local scene (position changes), which will be shared to the MR app.</span></span> <span data-ttu-id="f0c1a-747">Es sinnvoll, die app MR zuerst bereitstellen gefolgt von der Desktop-app, sodass der Empfänger lauscht beginnen kann.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-747">It makes sense to deploy the MR app first, followed by the Desktop app, so that the receiver can begin listening.</span></span>

<span data-ttu-id="f0c1a-748">Zum Bereitstellen der **UnityMRNotifHub** -app auf Ihrem lokalen Computer:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-748">To deploy the **UnityMRNotifHub** app on your Local Machine:</span></span>

1.  <span data-ttu-id="f0c1a-749">Öffnen Sie die Projektmappendatei, die von Ihrem **UnityMRNotifHub** -app in **Visual Studio 2017**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-749">Open the solution file of your **UnityMRNotifHub** app in **Visual Studio 2017**.</span></span>

2.  <span data-ttu-id="f0c1a-750">In der **Projektmappenplattform**Option **X86, lokalen Computer**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-750">In the **Solution Platform**, select **x86, Local Machine**.</span></span>

3.  <span data-ttu-id="f0c1a-751">In der **Projektmappenkonfiguration** wählen **Debuggen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-751">In the **Solution Configuration** select **Debug**.</span></span>

    ![Set-Projektkonfiguration](images/AzureLabs-Lab8-109.png)

4.  <span data-ttu-id="f0c1a-753">Wechseln Sie zu **Menü "Build"** und klicken Sie auf **Projektmappe bereitstellen** zum querladen der Anwendung auf Ihrem Computer.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-753">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your machine.</span></span>

5.  <span data-ttu-id="f0c1a-754">Ihre App sollte nun in der Liste der installierten apps, die zu startenden bereit angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-754">Your App should now appear in the list of installed apps, ready to be launched.</span></span>

<span data-ttu-id="f0c1a-755">Zum Bereitstellen der **UnityDesktopNotifHub** -app auf dem lokalen Computer:</span><span class="sxs-lookup"><span data-stu-id="f0c1a-755">To deploy the **UnityDesktopNotifHub** app on Local Machine:</span></span>

1.  <span data-ttu-id="f0c1a-756">Öffnen Sie die Projektmappendatei, die von Ihrem **UnityDesktopNotifHub** -app in **Visual Studio 2017**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-756">Open the solution file of your **UnityDesktopNotifHub** app in **Visual Studio 2017**.</span></span>

2.  <span data-ttu-id="f0c1a-757">In der **Projektmappenplattform**Option **X86, lokalen Computer**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-757">In the **Solution Platform**, select **x86, Local Machine**.</span></span>

3.  <span data-ttu-id="f0c1a-758">In der **Projektmappenkonfiguration** wählen **Debuggen**.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-758">In the **Solution Configuration** select **Debug**.</span></span>

    ![Set-Projektkonfiguration](images/AzureLabs-Lab8-110.png)

4.  <span data-ttu-id="f0c1a-760">Wechseln Sie zu **Menü "Build"** und klicken Sie auf **Projektmappe bereitstellen** zum querladen der Anwendung auf Ihrem Computer.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-760">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your machine.</span></span>

5.  <span data-ttu-id="f0c1a-761">Ihre App sollte nun in der Liste der installierten apps, die zu startenden bereit angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-761">Your App should now appear in the list of installed apps, ready to be launched.</span></span>

6.  <span data-ttu-id="f0c1a-762">Starten Sie die mixed Reality-Anwendung, und anschließend die Desktop-Anwendung.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-762">Launch the mixed reality application, followed by the Desktop application.</span></span>

<span data-ttu-id="f0c1a-763">Verschieben Sie mit beiden Anwendungen, die ausgeführt wird ein Objekt in der desktop Szene (mit der linken Maustaste).</span><span class="sxs-lookup"><span data-stu-id="f0c1a-763">With both applications running, move an object in the desktop scene (using the Left Mouse Button).</span></span> <span data-ttu-id="f0c1a-764">Diese Änderungen mit Feldern fester Breite werden lokal vorgenommen, serialisiert und an den Funktions-App-Dienst gesendet werden.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-764">These positional changes will be made locally, serialized, and sent to the Function App service.</span></span> <span data-ttu-id="f0c1a-765">Der Funktions-App-Dienst wird dann in der Tabelle zusammen mit dem Notification Hub aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-765">The Function App service will then update the Table along with the Notification Hub.</span></span> <span data-ttu-id="f0c1a-766">Müssen wurde ein Update, sendet Notification Hub aktualisierte die Daten direkt an alle registrierten Anwendungen (in diesem Fall die immersive Kopfhörer-app), die dann die eingehenden Daten zu deserialisieren, und die neuen mit Feldern fester Breite Daten auf die lokalen Objekte anwenden, Verschieben sie in der Szene.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-766">Having received an update, the Notification Hub will send the updated data directly to all the registered applications (in this case the immersive headset app), which will then deserialize the incoming data, and apply the new positional data to the local objects, moving them in scene.</span></span>


## <a name="your-finished-your-azure-notification-hubs-application"></a><span data-ttu-id="f0c1a-767">Ihre beendet die Anwendung für Azure Notification Hubs</span><span class="sxs-lookup"><span data-stu-id="f0c1a-767">Your finished your Azure Notification Hubs application</span></span>
 
<span data-ttu-id="f0c1a-768">Herzlichen Glückwunsch, Sie erstellt haben, eine mixed Reality-app, die den Azure Notification Hubs-Dienst nutzt, und ermöglichen die Kommunikation zwischen apps.</span><span class="sxs-lookup"><span data-stu-id="f0c1a-768">Congratulations, you built a mixed reality app that leverages the Azure Notification Hubs Service and allow communication between apps.</span></span>
 
![Endprodukt-Ende](images/AzureLabs-Lab8-00.png)
 
## <a name="bonus-exercises"></a><span data-ttu-id="f0c1a-770">Bonus-Übungen</span><span class="sxs-lookup"><span data-stu-id="f0c1a-770">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="f0c1a-771">Übung 1</span><span class="sxs-lookup"><span data-stu-id="f0c1a-771">Exercise 1</span></span>

<span data-ttu-id="f0c1a-772">Können Sie werden verwendet, wie Sie die Farbe der "gameobjects" ändern, und senden diese Benachrichtigung an andere apps, die die Szene anzeigen?</span><span class="sxs-lookup"><span data-stu-id="f0c1a-772">Can you work out how to change the color of the GameObjects and send that notification to other apps viewing the scene?</span></span>

### <a name="exercise-2"></a><span data-ttu-id="f0c1a-773">Übung 2</span><span class="sxs-lookup"><span data-stu-id="f0c1a-773">Exercise 2</span></span>

<span data-ttu-id="f0c1a-774">Können Sie Ihre app MR Verschiebung von der "gameobjects" hinzu, und finden Sie in Ihrer desktop-app unter der Szene aktualisiert?</span><span class="sxs-lookup"><span data-stu-id="f0c1a-774">Can you add movement of the GameObjects to your MR app and see the updated scene in your desktop app?</span></span>
