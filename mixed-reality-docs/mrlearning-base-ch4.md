...
2. Laden Sie das Unity-Paket [basemoduleassets Version 1.2.1](https://github.com/Developer-OI/MixedRealityLearning/releases/download/1.2.1/BaseModuleAssets-1.2.1.unitypackage) herunter, und importieren Sie es mit denselben Anweisungen zum Importieren von benutzerdefinierten Paketen, die in [Lesson1](mrlearning-base-ch1.md)beschrieben sind. Dieses Paket enthält 3D-Modelle und andere nützliche Ressourcen, die in diesem Tutorial verwendet werden.
