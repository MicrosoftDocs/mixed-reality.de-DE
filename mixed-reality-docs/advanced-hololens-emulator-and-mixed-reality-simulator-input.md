...
|  „Y“ zugeordnet ist |  Bild-auf/Bild-ab |  |  Dpad nach oben/unten | 
...
|----------|----------|----------|----------|
| Textkörper | (Standard) | (Standard) | (Standard) |
...
|  „Y“ zugeordnet ist |  Text nach oben/unten verschieben |  Hand/Controller nach oben/unten verschieben |  Kopf-/ausschalten | (Keine Aktion) |
...
|  Vorgang |  Tastatur und Maus |  Verantwortlicher | 
|----------|----------|----------|
...
|  Zurücksetzen |  ESCAPE-TASTE |  Starttaste | 
|  Paletten |  T |  X-Taste | 
